...
// ********** Begin Class UJumpFloodComponent2D ****************************************************
...
private: \
	...
	friend WATEREDITOR_API UClass* ::Z_Construct_UClass_UJumpFloodComponent2D_NoRegister(); \
public: \
	DECLARE_CLASS2(UJumpFloodComponent2D, UActorComponent, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/WaterEditor"), Z_Construct_UClass_UJumpFloodComponent2D_NoRegister) \
...
#define FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_JumpFloodComponent2D_h_16_ENHANCED_CONSTRUCTORS \
	...
	UJumpFloodComponent2D(UJumpFloodComponent2D&&) = delete; \
	UJumpFloodComponent2D(const UJumpFloodComponent2D&) = delete; \
...
// ********** End Class UJumpFloodComponent2D ******************************************************
