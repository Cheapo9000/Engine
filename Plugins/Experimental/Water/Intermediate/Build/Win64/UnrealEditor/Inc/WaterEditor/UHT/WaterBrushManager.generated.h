...
// ********** Begin Class AWaterBrushManager *******************************************************
...
private: \
	...
	friend WATEREDITOR_API UClass* ::Z_Construct_UClass_AWaterBrushManager_NoRegister(); \
public: \
	DECLARE_CLASS2(AWaterBrushManager, AWaterLandscapeBrush, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/WaterEditor"), Z_Construct_UClass_AWaterBrushManager_NoRegister) \
...
#define FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_WaterBrushManager_h_31_ENHANCED_CONSTRUCTORS \
	...
	AWaterBrushManager(AWaterBrushManager&&) = delete; \
	AWaterBrushManager(const AWaterBrushManager&) = delete; \
...
class AWaterBrushManager;

// ********** End Class AWaterBrushManager *********************************************************
