...
// ********** Begin Interface UVPBookmarkProvider **************************************************
...
#define FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPBookmark_Public_IVPBookmarkProvider_h_16_ENHANCED_CONSTRUCTORS \
	...
	UVPBookmarkProvider(UVPBookmarkProvider&&) = delete; \
	UVPBookmarkProvider(const UVPBookmarkProvider&) = delete; \
	...
	virtual ~UVPBookmarkProvider() = default;
...
private: \
	...
	friend VPBOOKMARK_API UClass* ::Z_Construct_UClass_UVPBookmarkProvider_NoRegister(); \
public: \
	DECLARE_CLASS2(UVPBookmarkProvider, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/VPBookmark"), Z_Construct_UClass_UVPBookmarkProvider_NoRegister) \
...
class UVPBookmarkProvider;

// ********** End Interface UVPBookmarkProvider ****************************************************
