...
// ********** Begin ScriptStruct FShotgridMenuItem *************************************************
...
struct FShotgridMenuItem;
// ********** End ScriptStruct FShotgridMenuItem ***************************************************

// ********** Begin Class UShotgridEngine **********************************************************
...
private: \
	...
	friend SHOTGRID_API UClass* ::Z_Construct_UClass_UShotgridEngine_NoRegister(); \
public: \
	DECLARE_CLASS2(UShotgridEngine, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Shotgrid"), Z_Construct_UClass_UShotgridEngine_NoRegister) \
...
#define FID_Engine_Plugins_Experimental_Shotgrid_Source_Shotgrid_Private_ShotgridEngine_h_42_ENHANCED_CONSTRUCTORS \
	...
	UShotgridEngine(UShotgridEngine&&) = delete; \
	UShotgridEngine(const UShotgridEngine&) = delete; \
