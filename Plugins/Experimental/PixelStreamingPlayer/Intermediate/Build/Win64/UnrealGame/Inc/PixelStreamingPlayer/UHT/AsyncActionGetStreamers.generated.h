...
// ********** Begin Delegate FOnStreamerListCompleted **********************************************
...
// ********** End Delegate FOnStreamerListCompleted ************************************************

// ********** Begin Class UAsyncAction_GetStreamers ************************************************
...
private: \
	...
	friend PIXELSTREAMINGPLAYER_API UClass* ::Z_Construct_UClass_UAsyncAction_GetStreamers_NoRegister(); \
public: \
	DECLARE_CLASS2(UAsyncAction_GetStreamers, UBlueprintAsyncActionBase, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/PixelStreamingPlayer"), Z_Construct_UClass_UAsyncAction_GetStreamers_NoRegister) \
...
#define FID_Engine_Plugins_Experimental_PixelStreamingPlayer_Source_PixelStreamingPlayer_Private_AsyncActionGetStreamers_h_13_ENHANCED_CONSTRUCTORS \
	...
	UAsyncAction_GetStreamers(UAsyncAction_GetStreamers&&) = delete; \
	UAsyncAction_GetStreamers(const UAsyncAction_GetStreamers&) = delete; \
...
// ********** End Class UAsyncAction_GetStreamers **************************************************
