...
private: \
	...
	URemapCurvesDebuggingProvider(const URemapCurvesDebuggingProvider&); \
public: \
	...
	NO_API virtual ~URemapCurvesDebuggingProvider();
...
public: \
	DECLARE_CLASS(URemapCurvesDebuggingProvider, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/CurveExpressionEditor"), NO_API) \
...
template<> CURVEEXPRESSIONEDITOR_API UClass* StaticClass<class URemapCurvesDebuggingProvider>();
