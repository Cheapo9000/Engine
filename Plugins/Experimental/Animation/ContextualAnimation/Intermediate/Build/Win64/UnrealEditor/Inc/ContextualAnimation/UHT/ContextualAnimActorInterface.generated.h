...
// ********** Begin Interface UContextualAnimActorInterface ****************************************
...
#define FID_Engine_Plugins_Experimental_Animation_ContextualAnimation_Source_ContextualAnimation_Public_ContextualAnimActorInterface_h_11_STANDARD_CONSTRUCTORS \
	...
	UContextualAnimActorInterface(UContextualAnimActorInterface&&) = delete; \
	UContextualAnimActorInterface(const UContextualAnimActorInterface&) = delete; \
	virtual ~UContextualAnimActorInterface() = default;
...
private: \
	...
	friend CONTEXTUALANIMATION_API UClass* ::Z_Construct_UClass_UContextualAnimActorInterface_NoRegister(); \
public: \
	DECLARE_CLASS2(UContextualAnimActorInterface, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/ContextualAnimation"), Z_Construct_UClass_UContextualAnimActorInterface_NoRegister) \
...
class UContextualAnimActorInterface;

// ********** End Interface UContextualAnimActorInterface ******************************************
