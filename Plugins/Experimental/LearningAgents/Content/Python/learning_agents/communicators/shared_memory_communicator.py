...
from learning_agents.communicators.shared_memory import SharedMemory
from learning_agents.train_common import (
    UE_RESPONSE_STOPPED, 
...
from learning_agents.train_common import save_snapshot, load_snapshot, build_network, get_merged_buffer, get_merged_stats, create_task_dir
...
class SharedMemoryCommunicator(AbstractCommunicator):
    ...
    def get_network(self, network_id):
        device = self.shared_memory_processes[0].config["Device"]
