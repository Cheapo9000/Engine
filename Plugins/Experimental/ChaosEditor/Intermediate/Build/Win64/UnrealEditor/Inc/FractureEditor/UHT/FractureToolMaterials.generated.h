...
public: \
	DECLARE_CLASS(UFractureMaterialsSettings, UFractureToolSettings, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/FractureEditor"), NO_API) \
...
private: \
	...
	UFractureMaterialsSettings(const UFractureMaterialsSettings&); \
public: \
...
template<> FRACTUREEDITOR_API UClass* StaticClass<class UFractureMaterialsSettings>();
...
public: \
	DECLARE_CLASS(UFractureToolMaterials, UFractureModalTool, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/FractureEditor"), NO_API) \
...
private: \
	...
	UFractureToolMaterials(const UFractureToolMaterials&); \
public: \
...
template<> FRACTUREEDITOR_API UClass* StaticClass<class UFractureToolMaterials>();
