...
// ********** Begin ScriptStruct FCinePrestreamingGenerateAssetArgs ********************************
...
struct FCinePrestreamingGenerateAssetArgs;
// ********** End ScriptStruct FCinePrestreamingGenerateAssetArgs **********************************

// ********** Begin Delegate FOnCinePrestreamingGenerateAsset **************************************
...
// ********** End Delegate FOnCinePrestreamingGenerateAsset ****************************************

// ********** Begin Class UCinePrestreamingEditorSubsystem *****************************************
...
private: \
	...
	friend CINEMATICPRESTREAMINGEDITOR_API UClass* ::Z_Construct_UClass_UCinePrestreamingEditorSubsystem_NoRegister(); \
public: \
	DECLARE_CLASS2(UCinePrestreamingEditorSubsystem, UEditorSubsystem, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/CinematicPrestreamingEditor"), Z_Construct_UClass_UCinePrestreamingEditorSubsystem_NoRegister) \
...
#define FID_Engine_Plugins_Experimental_CinematicPrestreaming_Source_CinematicPrestreamingEditor_Public_CinePrestreamingEditorSubsystem_h_42_ENHANCED_CONSTRUCTORS \
	...
	UCinePrestreamingEditorSubsystem(UCinePrestreamingEditorSubsystem&&) = delete; \
	UCinePrestreamingEditorSubsystem(const UCinePrestreamingEditorSubsystem&) = delete; \
...
class UCinePrestreamingEditorSubsystem;

// ********** End Class UCinePrestreamingEditorSubsystem *******************************************
