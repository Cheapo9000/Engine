...
// ********** Begin Class AModularVehicleClusterActor **********************************************
...
struct Z_Construct_UClass_AModularVehicleClusterActor_Statics;
CHAOSMODULARVEHICLEENGINE_API UClass* Z_Construct_UClass_AModularVehicleClusterActor_NoRegister();
...
private: \
	...
	friend CHAOSMODULARVEHICLEENGINE_API UClass* ::Z_Construct_UClass_AModularVehicleClusterActor_NoRegister(); \
public: \
	DECLARE_CLASS2(AModularVehicleClusterActor, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/ChaosModularVehicleEngine"), Z_Construct_UClass_AModularVehicleClusterActor_NoRegister) \
...
#define FID_Engine_Plugins_Experimental_ChaosModularVehicle_Source_ChaosModularVehicleEngine_Public_ChaosModularVehicle_ModularVehicleClusterActor_h_18_STANDARD_CONSTRUCTORS \
	...
	CHAOSMODULARVEHICLEENGINE_API AModularVehicleClusterActor(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
	DEFINE_DEFAULT_OBJECT_INITIALIZER_CONSTRUCTOR_CALL(AModularVehicleClusterActor) \
	DECLARE_VTABLE_PTR_HELPER_CTOR(CHAOSMODULARVEHICLEENGINE_API, AModularVehicleClusterActor); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AModularVehicleClusterActor); \
	/** Deleted move- and copy-constructors, should never be used */ \
	AModularVehicleClusterActor(AModularVehicleClusterActor&&) = delete; \
	AModularVehicleClusterActor(const AModularVehicleClusterActor&) = delete; \
	CHAOSMODULARVEHICLEENGINE_API virtual ~AModularVehicleClusterActor();
...
class AModularVehicleClusterActor;

// ********** End Class AModularVehicleClusterActor ************************************************
