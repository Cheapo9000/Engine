...
private: \
	...
	friend CHAOSNIAGARA_API UClass* ::Z_Construct_UClass_UNiagaraDataInterfaceGeometryCollection_NoRegister(); \
public: \
	DECLARE_CLASS2(UNiagaraDataInterfaceGeometryCollection, UNiagaraDataInterface, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/ChaosNiagara"), Z_Construct_UClass_UNiagaraDataInterfaceGeometryCollection_NoRegister) \
...
#define FID_Engine_Plugins_Experimental_ChaosNiagara_Source_ChaosNiagara_Public_NiagaraDataInterfaceGeometryCollection_h_187_STANDARD_CONSTRUCTORS \
	...
	UNiagaraDataInterfaceGeometryCollection(UNiagaraDataInterfaceGeometryCollection&&) = delete; \
	UNiagaraDataInterfaceGeometryCollection(const UNiagaraDataInterfaceGeometryCollection&) = delete; \
...
class UNiagaraDataInterfaceGeometryCollection;
...
template<> CHAOSNIAGARA_NON_ATTRIBUTED_API UEnum* StaticEnum<ENDIGeometryCollection_SourceMode>();
