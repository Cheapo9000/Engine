...
// ********** Begin Class UUserToolboxSubsystem ****************************************************
...
private: \
	...
	friend USERTOOLBOXCORE_API UClass* ::Z_Construct_UClass_UUserToolboxSubsystem_NoRegister(); \
public: \
	DECLARE_CLASS2(UUserToolboxSubsystem, UEditorSubsystem, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/UserToolBoxCore"), Z_Construct_UClass_UUserToolboxSubsystem_NoRegister) \
...
#define FID_Engine_Plugins_Experimental_UserToolBoxCore_Source_UserToolBoxCore_Public_UserToolBoxSubsystem_h_22_ENHANCED_CONSTRUCTORS \
	...
	UUserToolboxSubsystem(UUserToolboxSubsystem&&) = delete; \
	UUserToolboxSubsystem(const UUserToolboxSubsystem&) = delete; \
...
class UUserToolboxSubsystem;

// ********** End Class UUserToolboxSubsystem ******************************************************
