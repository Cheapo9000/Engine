...
// ********** Begin Class ALandmassErosionBrushBase ************************************************
...
struct Z_Construct_UClass_ALandmassErosionBrushBase_Statics;
LANDMASSEDITOR_API UClass* Z_Construct_UClass_ALandmassErosionBrushBase_NoRegister();
...
private: \
	...
	friend LANDMASSEDITOR_API UClass* ::Z_Construct_UClass_ALandmassErosionBrushBase_NoRegister(); \
public: \
	DECLARE_CLASS2(ALandmassErosionBrushBase, ALandscapeBlueprintBrushBase, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/LandmassEditor"), Z_Construct_UClass_ALandmassErosionBrushBase_NoRegister) \
...
#define FID_Engine_Plugins_Experimental_Landmass_Source_Editor_Public_LandmassErosionBrushBase_h_15_ENHANCED_CONSTRUCTORS \
	...
	ALandmassErosionBrushBase(ALandmassErosionBrushBase&&) = delete; \
	ALandmassErosionBrushBase(const ALandmassErosionBrushBase&) = delete; \
...
class ALandmassErosionBrushBase;

// ********** End Class ALandmassErosionBrushBase **************************************************
