...
template<> MOVEREXAMPLES_NON_ATTRIBUTED_API UEnum* StaticEnum<ESplineOffsetUnit>();
...
template<> MOVEREXAMPLES_NON_ATTRIBUTED_API UEnum* StaticEnum<EFollowSplineRotationType>();
