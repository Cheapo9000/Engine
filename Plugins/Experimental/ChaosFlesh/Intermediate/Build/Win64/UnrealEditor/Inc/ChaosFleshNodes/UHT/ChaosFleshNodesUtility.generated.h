...
// ********** Begin Enum TetMeshingMethod **********************************************************
#define FOREACH_ENUM_TETMESHINGMETHOD(op) \
	op(IsoStuffing) \
	op(TetWild) 

enum TetMeshingMethod : int;
template<> CHAOSFLESHNODES_NON_ATTRIBUTED_API UEnum* StaticEnum<TetMeshingMethod>();
// ********** End Enum TetMeshingMethod ************************************************************

// ********** Begin Enum ESkeletalSeletionMode *****************************************************
...
template<> CHAOSFLESHNODES_NON_ATTRIBUTED_API UEnum* StaticEnum<ESkeletalSeletionMode>();
// ********** End Enum ESkeletalSeletionMode *******************************************************
