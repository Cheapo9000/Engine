...
// ********** Begin Class UActorFactoryFlesh *******************************************************
...
private: \
	...
	friend CHAOSFLESHEDITOR_API UClass* ::Z_Construct_UClass_UActorFactoryFlesh_NoRegister(); \
public: \
	DECLARE_CLASS2(UActorFactoryFlesh, UActorFactory, COMPILED_IN_FLAGS(0 | CLASS_Transient | CLASS_Config), CASTCLASS_None, TEXT("/Script/ChaosFleshEditor"), Z_Construct_UClass_UActorFactoryFlesh_NoRegister) \
...
#define FID_Engine_Plugins_Experimental_ChaosFlesh_Source_ChaosFleshEditor_Private_ChaosFlesh_Asset_ActorFactoryFlesh_h_15_STANDARD_CONSTRUCTORS \
	...
	UActorFactoryFlesh(UActorFactoryFlesh&&) = delete; \
	UActorFactoryFlesh(const UActorFactoryFlesh&) = delete; \
...
class UActorFactoryFlesh;

// ********** End Class UActorFactoryFlesh *********************************************************
