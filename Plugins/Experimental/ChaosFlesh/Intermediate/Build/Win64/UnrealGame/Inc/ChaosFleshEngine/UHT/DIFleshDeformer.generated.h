...
// ********** Begin ScriptStruct FFleshDeformerParameters ******************************************
...
// ********** End ScriptStruct FFleshDeformerParameters ********************************************

// ********** Begin Class UDIFleshDeformer *********************************************************
...
private: \
	...
	friend CHAOSFLESHENGINE_API UClass* ::Z_Construct_UClass_UDIFleshDeformer_NoRegister(); \
public: \
	DECLARE_CLASS2(UDIFleshDeformer, UOptimusComputeDataInterface, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/ChaosFleshEngine"), Z_Construct_UClass_UDIFleshDeformer_NoRegister) \
...
#define FID_Engine_Plugins_Experimental_ChaosFlesh_Source_ChaosFleshEngine_Public_DataInterfaces_DIFleshDeformer_h_31_ENHANCED_CONSTRUCTORS \
	...
	UDIFleshDeformer(UDIFleshDeformer&&) = delete; \
	UDIFleshDeformer(const UDIFleshDeformer&) = delete; \
...
class UDIFleshDeformer;

// ********** End Class UDIFleshDeformer ***********************************************************

// ********** Begin Class UDIFleshDeformerDataProvider *********************************************
...
private: \
	...
	static UClass* GetPrivateStaticClass(); \
	friend CHAOSFLESHENGINE_API UClass* ::Z_Construct_UClass_UDIFleshDeformerDataProvider_NoRegister(); \
public: \
	DECLARE_CLASS2(UDIFleshDeformerDataProvider, UComputeDataProvider, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/ChaosFleshEngine"), Z_Construct_UClass_UDIFleshDeformerDataProvider_NoRegister) \
...
#define FID_Engine_Plugins_Experimental_ChaosFlesh_Source_ChaosFleshEngine_Public_DataInterfaces_DIFleshDeformer_h_63_ENHANCED_CONSTRUCTORS \
	...
	/** Deleted move- and copy-constructors, should never be used */ \
	UDIFleshDeformerDataProvider(UDIFleshDeformerDataProvider&&) = delete; \
	UDIFleshDeformerDataProvider(const UDIFleshDeformerDataProvider&) = delete; \
...
class UDIFleshDeformerDataProvider;

// ********** End Class UDIFleshDeformerDataProvider ***********************************************
