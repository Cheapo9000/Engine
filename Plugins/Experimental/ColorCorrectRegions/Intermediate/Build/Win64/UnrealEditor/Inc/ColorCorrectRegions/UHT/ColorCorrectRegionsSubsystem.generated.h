...
public: \
	DECLARE_CLASS(UColorCorrectRegionsSubsystem, UTickableWorldSubsystem, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/ColorCorrectRegions"), NO_API) \
...
private: \
	...
	UColorCorrectRegionsSubsystem(const UColorCorrectRegionsSubsystem&); \
public: \
...
template<> COLORCORRECTREGIONS_API UClass* StaticClass<class UColorCorrectRegionsSubsystem>();
