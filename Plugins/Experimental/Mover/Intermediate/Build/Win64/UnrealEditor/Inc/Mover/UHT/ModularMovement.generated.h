...
#define FID_Engine_Plugins_Experimental_Mover_Source_Mover_Public_MoveLibrary_ModularMovement_h_20_RPC_WRAPPERS_NO_PURE_DECLS \
	virtual FVector GetTurn_Implementation(FRotator TargetOrientation, FMoverTickStartData const& FullStartState, FMoverDefaultSyncState const& MoverState, FMoverTimeStep const& TimeStep, FProposedMove const& ProposedMove, UMoverBlackboard* SimBlackboard) { return FVector(ForceInit); }; \
...
public: \
	...
	MOVER_API static FVector Execute_GetTurn(UObject* O, FRotator TargetOrientation, FMoverTickStartData const& FullStartState, FMoverDefaultSyncState const& MoverState, FMoverTimeStep const& TimeStep, FProposedMove const& ProposedMove, UMoverBlackboard* SimBlackboard); \
