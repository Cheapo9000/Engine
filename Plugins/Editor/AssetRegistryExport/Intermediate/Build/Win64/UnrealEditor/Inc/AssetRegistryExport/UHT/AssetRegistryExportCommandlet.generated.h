...
// ********** Begin Class UAssetRegistryExportCommandlet *******************************************
...
private: \
	...
	friend ASSETREGISTRYEXPORT_API UClass* ::Z_Construct_UClass_UAssetRegistryExportCommandlet_NoRegister(); \
public: \
	DECLARE_CLASS2(UAssetRegistryExportCommandlet, UCommandlet, COMPILED_IN_FLAGS(0 | CLASS_Transient), CASTCLASS_None, TEXT("/Script/AssetRegistryExport"), Z_Construct_UClass_UAssetRegistryExportCommandlet_NoRegister) \
...
#define FID_Engine_Plugins_Editor_AssetRegistryExport_Source_Private_AssetRegistryExportCommandlet_h_12_STANDARD_CONSTRUCTORS \
	...
	UAssetRegistryExportCommandlet(UAssetRegistryExportCommandlet&&) = delete; \
	UAssetRegistryExportCommandlet(const UAssetRegistryExportCommandlet&) = delete; \
...
class UAssetRegistryExportCommandlet;

// ********** End Class UAssetRegistryExportCommandlet *********************************************
