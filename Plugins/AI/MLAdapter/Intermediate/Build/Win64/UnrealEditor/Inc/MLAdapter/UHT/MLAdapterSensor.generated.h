...
private: \
	...
	friend MLADAPTER_API UClass* ::Z_Construct_UClass_UMLAdapterSensor_NoRegister(); \
public: \
	DECLARE_CLASS2(UMLAdapterSensor, UMLAdapterAgentElement, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/MLAdapter"), Z_Construct_UClass_UMLAdapterSensor_NoRegister) \
...
#define FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Sensors_MLAdapterSensor_h_27_ENHANCED_CONSTRUCTORS \
	...
	UMLAdapterSensor(UMLAdapterSensor&&) = delete; \
	UMLAdapterSensor(const UMLAdapterSensor&) = delete; \
...
template<> MLADAPTER_NON_ATTRIBUTED_API UEnum* StaticEnum<EMLAdapterTickPolicy>();
// ********** End Enum EMLAdapterTickPolicy ********************************************************
