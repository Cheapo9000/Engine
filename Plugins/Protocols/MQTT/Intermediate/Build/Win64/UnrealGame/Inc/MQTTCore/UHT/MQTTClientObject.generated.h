...
// ********** Begin Class UMQTTSubscriptionObject **************************************************
...
private: \
	...
	friend MQTTCORE_API UClass* ::Z_Construct_UClass_UMQTTSubscriptionObject_NoRegister(); \
public: \
	DECLARE_CLASS2(UMQTTSubscriptionObject, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/MQTTCore"), Z_Construct_UClass_UMQTTSubscriptionObject_NoRegister) \
...
#define FID_Engine_Plugins_Protocols_MQTT_Source_MQTTCore_Public_MQTTClientObject_h_16_ENHANCED_CONSTRUCTORS \
	...
	UMQTTSubscriptionObject(UMQTTSubscriptionObject&&) = delete; \
	UMQTTSubscriptionObject(const UMQTTSubscriptionObject&) = delete; \
...
// ********** End Class UMQTTSubscriptionObject ****************************************************
...
private: \
	...
	static UClass* GetPrivateStaticClass(); \
	friend MQTTCORE_API UClass* ::Z_Construct_UClass_UMQTTClientObject_NoRegister(); \
public: \
	DECLARE_CLASS2(UMQTTClientObject, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/MQTTCore"), Z_Construct_UClass_UMQTTClientObject_NoRegister) \
...
#define FID_Engine_Plugins_Protocols_MQTT_Source_MQTTCore_Public_MQTTClientObject_h_55_ENHANCED_CONSTRUCTORS \
	...
	/** Deleted move- and copy-constructors, should never be used */ \
	UMQTTClientObject(UMQTTClientObject&&) = delete; \
	UMQTTClientObject(const UMQTTClientObject&) = delete; \
