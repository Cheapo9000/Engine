...
// ********** Begin ScriptStruct FNiagaraStatelessModuleEditorData *********************************
struct Z_Construct_UScriptStruct_FNiagaraStatelessModuleEditorData_Statics;
...
// ********** End ScriptStruct FNiagaraStatelessModuleEditorData ***********************************

// ********** Begin Class UNiagaraStackEditorData **************************************************
...
private: \
	...
	friend NIAGARAEDITOR_API UClass* ::Z_Construct_UClass_UNiagaraStackEditorData_NoRegister(); \
public: \
	DECLARE_CLASS2(UNiagaraStackEditorData, UNiagaraEditorDataBase, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/NiagaraEditor"), Z_Construct_UClass_UNiagaraStackEditorData_NoRegister) \
...
#define FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraStackEditorData_h_37_ENHANCED_CONSTRUCTORS \
	...
	UNiagaraStackEditorData(UNiagaraStackEditorData&&) = delete; \
	UNiagaraStackEditorData(const UNiagaraStackEditorData&) = delete; \
...
template<> NIAGARAEDITOR_NON_ATTRIBUTED_API UEnum* StaticEnum<ENiagaraStackEntryInlineDisplayMode>();
// ********** End Enum ENiagaraStackEntryInlineDisplayMode *****************************************
