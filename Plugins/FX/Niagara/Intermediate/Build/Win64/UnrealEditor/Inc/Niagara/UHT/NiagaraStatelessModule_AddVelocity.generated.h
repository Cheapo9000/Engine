...
private: \
	...
	friend NIAGARA_API UClass* ::Z_Construct_UClass_UNiagaraStatelessModule_AddVelocity_NoRegister(); \
public: \
	DECLARE_CLASS2(UNiagaraStatelessModule_AddVelocity, UNiagaraStatelessModule, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Niagara"), Z_Construct_UClass_UNiagaraStatelessModule_AddVelocity_NoRegister) \
...
#define FID_Engine_Plugins_FX_Niagara_Source_Niagara_Internal_Stateless_Modules_NiagaraStatelessModule_AddVelocity_h_24_ENHANCED_CONSTRUCTORS \
	...
	UNiagaraStatelessModule_AddVelocity(UNiagaraStatelessModule_AddVelocity&&) = delete; \
	UNiagaraStatelessModule_AddVelocity(const UNiagaraStatelessModule_AddVelocity&) = delete; \
...
class UNiagaraStatelessModule_AddVelocity;
...
template<> NIAGARA_NON_ATTRIBUTED_API UEnum* StaticEnum<ENSM_VelocityType>();
