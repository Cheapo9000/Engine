...
private: \
	...
	friend NIAGARA_API UClass* ::Z_Construct_UClass_UMovieSceneNiagaraParameterTrack_NoRegister(); \
public: \
	DECLARE_CLASS2(UMovieSceneNiagaraParameterTrack, UMovieSceneNiagaraTrack, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/Niagara"), Z_Construct_UClass_UMovieSceneNiagaraParameterTrack_NoRegister) \
...
#define FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_MovieScene_Parameters_MovieSceneNiagaraParameterTrack_h_14_ENHANCED_CONSTRUCTORS \
	...
	UMovieSceneNiagaraParameterTrack(UMovieSceneNiagaraParameterTrack&&) = delete; \
	UMovieSceneNiagaraParameterTrack(const UMovieSceneNiagaraParameterTrack&) = delete; \
