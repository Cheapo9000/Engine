...
// ********** Begin Class UNiagaraScriptFactoryNew *************************************************
...
private: \
	...
	friend NIAGARAEDITOR_API UClass* ::Z_Construct_UClass_UNiagaraScriptFactoryNew_NoRegister(); \
public: \
	DECLARE_CLASS2(UNiagaraScriptFactoryNew, UFactory, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/NiagaraEditor"), Z_Construct_UClass_UNiagaraScriptFactoryNew_NoRegister) \
...
#define FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraScriptFactoryNew_h_15_STANDARD_CONSTRUCTORS \
	...
	UNiagaraScriptFactoryNew(UNiagaraScriptFactoryNew&&) = delete; \
	UNiagaraScriptFactoryNew(const UNiagaraScriptFactoryNew&) = delete; \
...
class UNiagaraScriptFactoryNew;

// ********** End Class UNiagaraScriptFactoryNew ***************************************************

// ********** Begin Class UNiagaraModuleScriptFactory **********************************************
...
private: \
	...
	static UClass* GetPrivateStaticClass(); \
	friend NIAGARAEDITOR_API UClass* ::Z_Construct_UClass_UNiagaraModuleScriptFactory_NoRegister(); \
public: \
	DECLARE_CLASS2(UNiagaraModuleScriptFactory, UNiagaraScriptFactoryNew, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/NiagaraEditor"), Z_Construct_UClass_UNiagaraModuleScriptFactory_NoRegister) \
...
#define FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraScriptFactoryNew_h_43_STANDARD_CONSTRUCTORS \
	...
	/** Deleted move- and copy-constructors, should never be used */ \
	UNiagaraModuleScriptFactory(UNiagaraModuleScriptFactory&&) = delete; \
	UNiagaraModuleScriptFactory(const UNiagaraModuleScriptFactory&) = delete; \
...
class UNiagaraModuleScriptFactory;

// ********** End Class UNiagaraModuleScriptFactory ************************************************

// ********** Begin Class UNiagaraFunctionScriptFactory ********************************************
...
private: \
	...
	static UClass* GetPrivateStaticClass(); \
	friend NIAGARAEDITOR_API UClass* ::Z_Construct_UClass_UNiagaraFunctionScriptFactory_NoRegister(); \
public: \
	DECLARE_CLASS2(UNiagaraFunctionScriptFactory, UNiagaraScriptFactoryNew, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/NiagaraEditor"), Z_Construct_UClass_UNiagaraFunctionScriptFactory_NoRegister) \
...
#define FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraScriptFactoryNew_h_63_STANDARD_CONSTRUCTORS \
	...
	/** Deleted move- and copy-constructors, should never be used */ \
	UNiagaraFunctionScriptFactory(UNiagaraFunctionScriptFactory&&) = delete; \
	UNiagaraFunctionScriptFactory(const UNiagaraFunctionScriptFactory&) = delete; \
...
class UNiagaraFunctionScriptFactory;

// ********** End Class UNiagaraFunctionScriptFactory **********************************************

// ********** Begin Class UNiagaraDynamicInputScriptFactory ****************************************
...
private: \
	...
	static UClass* GetPrivateStaticClass(); \
	friend NIAGARAEDITOR_API UClass* ::Z_Construct_UClass_UNiagaraDynamicInputScriptFactory_NoRegister(); \
public: \
	DECLARE_CLASS2(UNiagaraDynamicInputScriptFactory, UNiagaraScriptFactoryNew, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/NiagaraEditor"), Z_Construct_UClass_UNiagaraDynamicInputScriptFactory_NoRegister) \
...
#define FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraScriptFactoryNew_h_82_STANDARD_CONSTRUCTORS \
	...
	/** Deleted move- and copy-constructors, should never be used */ \
	UNiagaraDynamicInputScriptFactory(UNiagaraDynamicInputScriptFactory&&) = delete; \
	UNiagaraDynamicInputScriptFactory(const UNiagaraDynamicInputScriptFactory&) = delete; \
...
class UNiagaraDynamicInputScriptFactory;

// ********** End Class UNiagaraDynamicInputScriptFactory ******************************************
