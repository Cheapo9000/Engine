...
private: \
	...
	friend NIAGARA_API UClass* ::Z_Construct_UClass_UNiagaraDataInterfaceSocketReader_NoRegister(); \
public: \
	DECLARE_CLASS2(UNiagaraDataInterfaceSocketReader, UNiagaraDataInterface, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Niagara"), Z_Construct_UClass_UNiagaraDataInterfaceSocketReader_NoRegister) \
...
#define FID_Engine_Plugins_FX_Niagara_Source_Niagara_Internal_DataInterface_NiagaraDataInterfaceSocketReader_h_34_STANDARD_CONSTRUCTORS \
	...
	UNiagaraDataInterfaceSocketReader(UNiagaraDataInterfaceSocketReader&&) = delete; \
	UNiagaraDataInterfaceSocketReader(const UNiagaraDataInterfaceSocketReader&) = delete; \
...
template<> NIAGARA_NON_ATTRIBUTED_API UEnum* StaticEnum<ENDISocketReaderSourceMode>();
