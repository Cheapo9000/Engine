...
// ********** Begin Class UNiagaraNodeReadDataSet **************************************************
...
private: \
	...
	friend NIAGARAEDITOR_API UClass* ::Z_Construct_UClass_UNiagaraNodeReadDataSet_NoRegister(); \
public: \
	DECLARE_CLASS2(UNiagaraNodeReadDataSet, UNiagaraNodeDataSetBase, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/NiagaraEditor"), Z_Construct_UClass_UNiagaraNodeReadDataSet_NoRegister) \
...
#define FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraNodeReadDataSet_h_15_STANDARD_CONSTRUCTORS \
	...
	UNiagaraNodeReadDataSet(UNiagaraNodeReadDataSet&&) = delete; \
	UNiagaraNodeReadDataSet(const UNiagaraNodeReadDataSet&) = delete; \
...
class UNiagaraNodeReadDataSet;

// ********** End Class UNiagaraNodeReadDataSet ****************************************************
