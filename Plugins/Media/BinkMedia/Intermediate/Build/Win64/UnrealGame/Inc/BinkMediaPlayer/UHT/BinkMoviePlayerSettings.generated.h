...
template<> BINKMEDIAPLAYER_NON_ATTRIBUTED_API UEnum* StaticEnum<EBinkMoviePlayerBinkBufferModes>();
...
template<> BINKMEDIAPLAYER_NON_ATTRIBUTED_API UEnum* StaticEnum<EBinkMoviePlayerBinkSoundTrack>();
