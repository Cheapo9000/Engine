...
template<> NDIMEDIA_NON_ATTRIBUTED_API UEnum* StaticEnum<ENDIMediaOutputPixelFormat>();
...
template<> NDIMEDIA_NON_ATTRIBUTED_API UEnum* StaticEnum<ENDIMediaOutputAudioSampleRate>();
