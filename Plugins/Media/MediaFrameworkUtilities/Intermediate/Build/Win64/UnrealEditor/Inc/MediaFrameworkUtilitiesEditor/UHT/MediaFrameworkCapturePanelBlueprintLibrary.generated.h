...
// ********** Begin Class UMediaFrameworkCapturePanel **********************************************
...
private: \
	...
	friend MEDIAFRAMEWORKUTILITIESEDITOR_API UClass* ::Z_Construct_UClass_UMediaFrameworkCapturePanel_NoRegister(); \
public: \
	DECLARE_CLASS2(UMediaFrameworkCapturePanel, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/MediaFrameworkUtilitiesEditor"), Z_Construct_UClass_UMediaFrameworkCapturePanel_NoRegister) \
...
#define FID_Engine_Plugins_Media_MediaFrameworkUtilities_Source_MediaFrameworkUtilitiesEditor_Private_CaptureTab_MediaFrameworkCapturePanelBlueprintLibrary_h_24_ENHANCED_CONSTRUCTORS \
	...
	UMediaFrameworkCapturePanel(UMediaFrameworkCapturePanel&&) = delete; \
	UMediaFrameworkCapturePanel(const UMediaFrameworkCapturePanel&) = delete; \
...
// ********** End Class UMediaFrameworkCapturePanel ************************************************

// ********** Begin Class UMediaFrameworkCapturePanelBlueprintLibrary ******************************
...
private: \
	...
	static UClass* GetPrivateStaticClass(); \
	friend MEDIAFRAMEWORKUTILITIESEDITOR_API UClass* ::Z_Construct_UClass_UMediaFrameworkCapturePanelBlueprintLibrary_NoRegister(); \
public: \
	DECLARE_CLASS2(UMediaFrameworkCapturePanelBlueprintLibrary, UBlueprintFunctionLibrary, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/MediaFrameworkUtilitiesEditor"), Z_Construct_UClass_UMediaFrameworkCapturePanelBlueprintLibrary_NoRegister) \
...
#define FID_Engine_Plugins_Media_MediaFrameworkUtilities_Source_MediaFrameworkUtilitiesEditor_Private_CaptureTab_MediaFrameworkCapturePanelBlueprintLibrary_h_74_ENHANCED_CONSTRUCTORS \
	...
	/** Deleted move- and copy-constructors, should never be used */ \
	UMediaFrameworkCapturePanelBlueprintLibrary(UMediaFrameworkCapturePanelBlueprintLibrary&&) = delete; \
	UMediaFrameworkCapturePanelBlueprintLibrary(const UMediaFrameworkCapturePanelBlueprintLibrary&) = delete; \
...
class UMediaFrameworkCapturePanelBlueprintLibrary;

// ********** End Class UMediaFrameworkCapturePanelBlueprintLibrary ********************************
