...
// ********** Begin Class UHttpRequestProxyObject **************************************************
...
private: \
	...
	friend HTTPBLUEPRINT_API UClass* ::Z_Construct_UClass_UHttpRequestProxyObject_NoRegister(); \
public: \
	DECLARE_CLASS2(UHttpRequestProxyObject, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/HttpBlueprint"), Z_Construct_UClass_UHttpRequestProxyObject_NoRegister) \
...
#define FID_Engine_Plugins_Web_HttpBlueprint_Source_HttpBlueprint_Internal_HttpRequestProxyObject_h_15_ENHANCED_CONSTRUCTORS \
	...
	UHttpRequestProxyObject(UHttpRequestProxyObject&&) = delete; \
	UHttpRequestProxyObject(const UHttpRequestProxyObject&) = delete; \
...
// ********** End Class UHttpRequestProxyObject ****************************************************
