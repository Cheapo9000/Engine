...
private: \
	...
	friend GAMEPLAYCAMERAS_API UClass* ::Z_Construct_UClass_USmoothBlendCameraNode_NoRegister(); \
public: \
	DECLARE_CLASS2(USmoothBlendCameraNode, USimpleFixedTimeBlendCameraNode, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/GameplayCameras"), Z_Construct_UClass_USmoothBlendCameraNode_NoRegister) \
...
#define FID_Engine_Plugins_Cameras_GameplayCameras_Source_GameplayCameras_Public_Nodes_Blends_SmoothBlendCameraNode_h_25_ENHANCED_CONSTRUCTORS \
	...
	USmoothBlendCameraNode(USmoothBlendCameraNode&&) = delete; \
	USmoothBlendCameraNode(const USmoothBlendCameraNode&) = delete; \
...
template<> GAMEPLAYCAMERAS_NON_ATTRIBUTED_API UEnum* StaticEnum<ESmoothCameraBlendType>();
