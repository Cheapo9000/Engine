...
private: \
	...
	friend GAMEPLAYCAMERAS_API UClass* ::Z_Construct_UClass_UCollisionPushCameraNode_NoRegister(); \
public: \
	DECLARE_CLASS2(UCollisionPushCameraNode, UCameraNode, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/GameplayCameras"), Z_Construct_UClass_UCollisionPushCameraNode_NoRegister) \
...
#define FID_Engine_Plugins_Cameras_GameplayCameras_Source_GameplayCameras_Public_Nodes_Collision_CollisionPushCameraNode_h_68_ENHANCED_CONSTRUCTORS \
	...
	UCollisionPushCameraNode(UCollisionPushCameraNode&&) = delete; \
	UCollisionPushCameraNode(const UCollisionPushCameraNode&) = delete; \
...
class UCollisionPushCameraNode;
...
template<> GAMEPLAYCAMERAS_NON_ATTRIBUTED_API UEnum* StaticEnum<ECollisionSafePosition>();
...
template<> GAMEPLAYCAMERAS_NON_ATTRIBUTED_API UEnum* StaticEnum<ECollisionSafePositionOffsetSpace>();
