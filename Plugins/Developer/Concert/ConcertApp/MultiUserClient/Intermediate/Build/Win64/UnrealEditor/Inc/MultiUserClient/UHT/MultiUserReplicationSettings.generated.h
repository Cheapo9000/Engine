...
// ********** Begin Class UMultiUserReplicationSettings ********************************************
struct Z_Construct_UClass_UMultiUserReplicationSettings_Statics;
MULTIUSERCLIENT_API UClass* Z_Construct_UClass_UMultiUserReplicationSettings_NoRegister();
...
private: \
	...
	friend MULTIUSERCLIENT_API UClass* ::Z_Construct_UClass_UMultiUserReplicationSettings_NoRegister(); \
public: \
	DECLARE_CLASS2(UMultiUserReplicationSettings, UObject, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/MultiUserClient"), Z_Construct_UClass_UMultiUserReplicationSettings_NoRegister) \
	DECLARE_SERIALIZER(UMultiUserReplicationSettings) \
	static constexpr const TCHAR* StaticConfigName() {return TEXT("MultiUserClient");} \
...
#define FID_Engine_Plugins_Developer_Concert_ConcertApp_MultiUserClient_Source_MultiUserClient_Private_Settings_MultiUserReplicationSettings_h_16_ENHANCED_CONSTRUCTORS \
	...
	UMultiUserReplicationSettings(UMultiUserReplicationSettings&&) = delete; \
	UMultiUserReplicationSettings(const UMultiUserReplicationSettings&) = delete; \
...
class UMultiUserReplicationSettings;

// ********** End Class UMultiUserReplicationSettings **********************************************
