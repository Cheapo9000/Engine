...
// ********** Begin Delegate FOnServerStateChanged *************************************************
...
// ********** End Delegate FOnServerStateChanged ***************************************************

// ********** Begin Delegate FOnOfflineClientsChanged **********************************************
...
// ********** End Delegate FOnOfflineClientsChanged ************************************************

// ********** Begin Class UMultiUserReplicationSubsystem *******************************************
...
struct Z_Construct_UClass_UMultiUserReplicationSubsystem_Statics;
MULTIUSERCLIENTLIBRARY_API UClass* Z_Construct_UClass_UMultiUserReplicationSubsystem_NoRegister();
...
private: \
	...
	friend MULTIUSERCLIENTLIBRARY_API UClass* ::Z_Construct_UClass_UMultiUserReplicationSubsystem_NoRegister(); \
public: \
	DECLARE_CLASS2(UMultiUserReplicationSubsystem, UEngineSubsystem, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/MultiUserClientLibrary"), Z_Construct_UClass_UMultiUserReplicationSubsystem_NoRegister) \
...
#define FID_Engine_Plugins_Developer_Concert_ConcertApp_MultiUserClient_Source_MultiUserClientLibrary_Public_Replication_MultiUserReplicationSubsystem_h_20_ENHANCED_CONSTRUCTORS \
	...
	UMultiUserReplicationSubsystem(UMultiUserReplicationSubsystem&&) = delete; \
	UMultiUserReplicationSubsystem(const UMultiUserReplicationSubsystem&) = delete; \
...
class UMultiUserReplicationSubsystem;

// ********** End Class UMultiUserReplicationSubsystem *********************************************
