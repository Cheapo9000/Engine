...
def create_performance_asset(path_to_identity : str, path_to_capture_data : str, save_performance_location : str) -> unreal.MetaHumanPerformance:
    """
    Returns a newly created MetaHuman Performance asset based on the input identity and capture data. 
    ...
    performance_asset.set_editor_property("input_type", unreal.DataInputType.DEPTH_FOOTAGE)
...
def run():
    ...
    parser = argparse.ArgumentParser(prog=sys.argv[0], description=
        'This script is used to create a MetaHuman Performance asset and process a depth-based shot '
    ...
    parser.add_argument("--identity-path", type=str, required=True, help="Content path to identity asset to be used by the performance")
