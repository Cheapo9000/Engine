...
// ********** Begin ScriptStruct FSequencerTrackInstanceInput **************************************
...
struct FSequencerTrackInstanceInput;
// ********** End ScriptStruct FSequencerTrackInstanceInput ****************************************

// ********** Begin Class USequencerTrackInstanceBP ************************************************
...
private: \
	...
	friend CUSTOMIZABLESEQUENCERTRACKS_API UClass* ::Z_Construct_UClass_USequencerTrackInstanceBP_NoRegister(); \
public: \
	DECLARE_CLASS2(USequencerTrackInstanceBP, UMovieSceneTrackInstance, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Transient), CASTCLASS_None, TEXT("/Script/CustomizableSequencerTracks"), Z_Construct_UClass_USequencerTrackInstanceBP_NoRegister) \
...
#define FID_Engine_Plugins_MovieScene_CustomizableSequencerTracks_Source_CustomizableSequencerTracks_Public_SequencerTrackInstanceBP_h_35_ENHANCED_CONSTRUCTORS \
	...
	USequencerTrackInstanceBP(USequencerTrackInstanceBP&&) = delete; \
	USequencerTrackInstanceBP(const USequencerTrackInstanceBP&) = delete; \
...
class USequencerTrackInstanceBP;

// ********** End Class USequencerTrackInstanceBP **************************************************
