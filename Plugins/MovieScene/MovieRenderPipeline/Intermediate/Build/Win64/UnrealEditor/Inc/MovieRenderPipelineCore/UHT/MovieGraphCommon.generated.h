...
// ********** Begin Enum EMovieGraphValueType ******************************************************
#define FOREACH_ENUM_EMOVIEGRAPHVALUETYPE(op) \
	...
	op(EMovieGraphValueType::UInt32) \
	op(EMovieGraphValueType::UInt64) \
...
template<> MOVIERENDERPIPELINECORE_NON_ATTRIBUTED_API UEnum* StaticEnum<EMovieGraphValueType>();
// ********** End Enum EMovieGraphValueType ********************************************************

// ********** Begin Enum EMovieGraphContainerType **************************************************
#define FOREACH_ENUM_EMOVIEGRAPHCONTAINERTYPE(op) \
	op(EMovieGraphContainerType::None) \
	op(EMovieGraphContainerType::Array) \
	op(EMovieGraphContainerType::Set) \
...
template<> MOVIERENDERPIPELINECORE_NON_ATTRIBUTED_API UEnum* StaticEnum<EMovieGraphContainerType>();
// ********** End Enum EMovieGraphContainerType ****************************************************
