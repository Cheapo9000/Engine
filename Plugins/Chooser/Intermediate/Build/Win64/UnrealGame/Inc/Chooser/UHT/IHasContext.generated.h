...
// ********** Begin Interface UHasContextClass *****************************************************
...
#define FID_Engine_Plugins_Chooser_Source_Chooser_Public_IHasContext_h_16_ENHANCED_CONSTRUCTORS \
	...
	UHasContextClass(UHasContextClass&&) = delete; \
	UHasContextClass(const UHasContextClass&) = delete; \
	...
	virtual ~UHasContextClass() = default;
...
private: \
	...
	friend CHOOSER_API UClass* ::Z_Construct_UClass_UHasContextClass_NoRegister(); \
public: \
	DECLARE_CLASS2(UHasContextClass, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/Chooser"), Z_Construct_UClass_UHasContextClass_NoRegister) \
...
#define FOREACH_ENUM_EOBJECTCHOOSERRESULTTYPE(op) \
	...
	op(EObjectChooserResultType::NoPrimaryResult) 

enum class EObjectChooserResultType;
template<> struct TIsUEnumClass<EObjectChooserResultType> { enum { Value = true }; };
template<> CHOOSER_NON_ATTRIBUTED_API UEnum* StaticEnum<EObjectChooserResultType>();
// ********** End Enum EObjectChooserResultType ****************************************************
