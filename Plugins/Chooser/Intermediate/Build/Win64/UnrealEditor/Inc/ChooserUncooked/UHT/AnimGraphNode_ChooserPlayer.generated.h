...
// ********** Begin Class UAnimGraphNode_ChooserPlayer *********************************************
#define FID_Engine_Plugins_Chooser_Source_ChooserUncooked_Public_AnimGraphNode_ChooserPlayer_h_16_ARCHIVESERIALIZER \
	DECLARE_FSTRUCTUREDARCHIVE_SERIALIZER(UAnimGraphNode_ChooserPlayer, CHOOSERUNCOOKED_API)


struct Z_Construct_UClass_UAnimGraphNode_ChooserPlayer_Statics;
CHOOSERUNCOOKED_API UClass* Z_Construct_UClass_UAnimGraphNode_ChooserPlayer_NoRegister();
...
private: \
	...
	friend CHOOSERUNCOOKED_API UClass* ::Z_Construct_UClass_UAnimGraphNode_ChooserPlayer_NoRegister(); \
public: \
	DECLARE_CLASS2(UAnimGraphNode_ChooserPlayer, UAnimGraphNode_BlendStack_Base, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/ChooserUncooked"), Z_Construct_UClass_UAnimGraphNode_ChooserPlayer_NoRegister) \
	DECLARE_SERIALIZER(UAnimGraphNode_ChooserPlayer) \
	FID_Engine_Plugins_Chooser_Source_ChooserUncooked_Public_AnimGraphNode_ChooserPlayer_h_16_ARCHIVESERIALIZER \
...
#define FID_Engine_Plugins_Chooser_Source_ChooserUncooked_Public_AnimGraphNode_ChooserPlayer_h_16_ENHANCED_CONSTRUCTORS \
	...
	UAnimGraphNode_ChooserPlayer(UAnimGraphNode_ChooserPlayer&&) = delete; \
	UAnimGraphNode_ChooserPlayer(const UAnimGraphNode_ChooserPlayer&) = delete; \
...
// ********** End Class UAnimGraphNode_ChooserPlayer ***********************************************
