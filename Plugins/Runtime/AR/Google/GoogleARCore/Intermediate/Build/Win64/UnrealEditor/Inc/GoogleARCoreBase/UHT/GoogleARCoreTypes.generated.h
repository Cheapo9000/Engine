...
// ********** Begin ScriptStruct FGoogleARCoreCameraConfig *****************************************
...
struct FGoogleARCoreCameraConfig;
// ********** End ScriptStruct FGoogleARCoreCameraConfig *******************************************

// ********** Begin Delegate FGoogleARCoreOnConfigCameraDynamicDelegate ****************************
...
// ********** End Delegate FGoogleARCoreOnConfigCameraDynamicDelegate ******************************

// ********** Begin Class UGoogleARCoreEventManager ************************************************
...
private: \
	...
	friend GOOGLEARCOREBASE_API UClass* ::Z_Construct_UClass_UGoogleARCoreEventManager_NoRegister(); \
public: \
	DECLARE_CLASS2(UGoogleARCoreEventManager, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/GoogleARCoreBase"), Z_Construct_UClass_UGoogleARCoreEventManager_NoRegister) \
...
#define FID_Engine_Plugins_Runtime_AR_Google_GoogleARCore_Source_GoogleARCoreBase_Public_GoogleARCoreTypes_h_316_ENHANCED_CONSTRUCTORS \
	...
	UGoogleARCoreEventManager(UGoogleARCoreEventManager&&) = delete; \
	UGoogleARCoreEventManager(const UGoogleARCoreEventManager&) = delete; \
...
// ********** End Class UGoogleARCoreEventManager **************************************************

// ********** Begin Class UGoogleARCorePointCloud **************************************************
...
private: \
	...
	static UClass* GetPrivateStaticClass(); \
	friend GOOGLEARCOREBASE_API UClass* ::Z_Construct_UClass_UGoogleARCorePointCloud_NoRegister(); \
public: \
	DECLARE_CLASS2(UGoogleARCorePointCloud, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/GoogleARCoreBase"), Z_Construct_UClass_UGoogleARCorePointCloud_NoRegister) \
...
#define FID_Engine_Plugins_Runtime_AR_Google_GoogleARCore_Source_GoogleARCoreBase_Public_GoogleARCoreTypes_h_375_ENHANCED_CONSTRUCTORS \
	...
	/** Deleted move- and copy-constructors, should never be used */ \
	UGoogleARCorePointCloud(UGoogleARCorePointCloud&&) = delete; \
	UGoogleARCorePointCloud(const UGoogleARCorePointCloud&) = delete; \
...
// ********** End Class UGoogleARCorePointCloud ****************************************************

// ********** Begin Class UGoogleARCoreEditorSettings **********************************************
...
private: \
	...
	static UClass* GetPrivateStaticClass(); \
	friend GOOGLEARCOREBASE_API UClass* ::Z_Construct_UClass_UGoogleARCoreEditorSettings_NoRegister(); \
public: \
	DECLARE_CLASS2(UGoogleARCoreEditorSettings, UObject, COMPILED_IN_FLAGS(0 | CLASS_DefaultConfig | CLASS_Config), CASTCLASS_None, TEXT("/Script/GoogleARCoreBase"), Z_Construct_UClass_UGoogleARCoreEditorSettings_NoRegister) \
...
#define FID_Engine_Plugins_Runtime_AR_Google_GoogleARCore_Source_GoogleARCoreBase_Public_GoogleARCoreTypes_h_427_ENHANCED_CONSTRUCTORS \
	...
	/** Deleted move- and copy-constructors, should never be used */ \
	UGoogleARCoreEditorSettings(UGoogleARCoreEditorSettings&&) = delete; \
	UGoogleARCoreEditorSettings(const UGoogleARCoreEditorSettings&) = delete; \
...
class UGoogleARCoreEditorSettings;

// ********** End Class UGoogleARCoreEditorSettings ************************************************
...
// ********** Begin Enum EGoogleARCoreFunctionStatus ***********************************************
...
template<> GOOGLEARCOREBASE_NON_ATTRIBUTED_API UEnum* StaticEnum<EGoogleARCoreFunctionStatus>();
// ********** End Enum EGoogleARCoreFunctionStatus *************************************************

// ********** Begin Enum EGoogleARCoreLineTraceChannel *********************************************
...
template<> GOOGLEARCOREBASE_NON_ATTRIBUTED_API UEnum* StaticEnum<EGoogleARCoreLineTraceChannel>();
// ********** End Enum EGoogleARCoreLineTraceChannel ***********************************************

// ********** Begin Enum EGoogleARCoreCameraFacing *************************************************
...
template<> GOOGLEARCOREBASE_NON_ATTRIBUTED_API UEnum* StaticEnum<EGoogleARCoreCameraFacing>();
// ********** End Enum EGoogleARCoreCameraFacing ***************************************************

// ********** Begin Enum EGoogleARCoreAugmentedFaceMode ********************************************
...
template<> GOOGLEARCOREBASE_NON_ATTRIBUTED_API UEnum* StaticEnum<EGoogleARCoreAugmentedFaceMode>();
// ********** End Enum EGoogleARCoreAugmentedFaceMode **********************************************

// ********** Begin Enum EGoogleARCoreTrackingFailureReason ****************************************
...
template<> GOOGLEARCOREBASE_NON_ATTRIBUTED_API UEnum* StaticEnum<EGoogleARCoreTrackingFailureReason>();
// ********** End Enum EGoogleARCoreTrackingFailureReason ******************************************

// ********** Begin Enum EGoogleARCoreCameraFPS ****************************************************
...
template<> GOOGLEARCOREBASE_NON_ATTRIBUTED_API UEnum* StaticEnum<EGoogleARCoreCameraFPS>();
// ********** End Enum EGoogleARCoreCameraFPS ******************************************************

// ********** Begin Enum EGoogleARCoreCameraDepthSensorUsage ***************************************
...
template<> GOOGLEARCOREBASE_NON_ATTRIBUTED_API UEnum* StaticEnum<EGoogleARCoreCameraDepthSensorUsage>();
// ********** End Enum EGoogleARCoreCameraDepthSensorUsage *****************************************
