...
// ********** Begin Interface UDisplayClusterProjectionBlueprintAPI ********************************
...
#define FID_Engine_Plugins_Runtime_nDisplay_Source_DisplayClusterProjection_Public_Blueprints_IDisplayClusterProjectionBlueprintAPI_h_16_ENHANCED_CONSTRUCTORS \
	...
	UDisplayClusterProjectionBlueprintAPI(UDisplayClusterProjectionBlueprintAPI&&) = delete; \
	UDisplayClusterProjectionBlueprintAPI(const UDisplayClusterProjectionBlueprintAPI&) = delete; \
	...
	virtual ~UDisplayClusterProjectionBlueprintAPI() = default;
...
private: \
	...
	friend DISPLAYCLUSTERPROJECTION_API UClass* ::Z_Construct_UClass_UDisplayClusterProjectionBlueprintAPI_NoRegister(); \
public: \
	DECLARE_CLASS2(UDisplayClusterProjectionBlueprintAPI, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/DisplayClusterProjection"), Z_Construct_UClass_UDisplayClusterProjectionBlueprintAPI_NoRegister) \
...
class UDisplayClusterProjectionBlueprintAPI;

// ********** End Interface UDisplayClusterProjectionBlueprintAPI **********************************
