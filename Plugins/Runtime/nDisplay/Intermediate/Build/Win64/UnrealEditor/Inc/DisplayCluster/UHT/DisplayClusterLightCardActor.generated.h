...
// ********** Begin ScriptStruct FLightCardAlphaGradientSettings ***********************************
...
// ********** End ScriptStruct FLightCardAlphaGradientSettings *************************************

// ********** Begin Class ADisplayClusterLightCardActor ********************************************
...
private: \
	...
	friend DISPLAYCLUSTER_API UClass* ::Z_Construct_UClass_ADisplayClusterLightCardActor_NoRegister(); \
public: \
	DECLARE_CLASS2(ADisplayClusterLightCardActor, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/DisplayCluster"), Z_Construct_UClass_ADisplayClusterLightCardActor_NoRegister) \
...
#define FID_Engine_Plugins_Runtime_nDisplay_Source_DisplayCluster_Public_DisplayClusterLightCardActor_h_60_ENHANCED_CONSTRUCTORS \
	...
	ADisplayClusterLightCardActor(ADisplayClusterLightCardActor&&) = delete; \
	ADisplayClusterLightCardActor(const ADisplayClusterLightCardActor&) = delete; \
...
// ********** End Class ADisplayClusterLightCardActor **********************************************
...
// ********** Begin Enum EDisplayClusterLightCardMask **********************************************
...
template<> DISPLAYCLUSTER_NON_ATTRIBUTED_API UEnum* StaticEnum<EDisplayClusterLightCardMask>();
// ********** End Enum EDisplayClusterLightCardMask ************************************************
