...
#define FID_Engine_Plugins_Runtime_USDCore_Source_UnrealUSDWrapper_Public_UnrealUSDWrapper_h_217_GENERATED_BODY \
...
#define FID_Engine_Plugins_Runtime_USDCore_Source_UnrealUSDWrapper_Public_UnrealUSDWrapper_h_235_GENERATED_BODY \
...
template<> UNREALUSDWRAPPER_NON_ATTRIBUTED_API UEnum* StaticEnum<EUsdPurpose>();
...
template<> UNREALUSDWRAPPER_NON_ATTRIBUTED_API UEnum* StaticEnum<EUsdDefaultKind>();
...
template<> UNREALUSDWRAPPER_NON_ATTRIBUTED_API UEnum* StaticEnum<EUsdLoadPolicy>();
...
template<> UNREALUSDWRAPPER_NON_ATTRIBUTED_API UEnum* StaticEnum<EUsdInitialLoadSet>();
...
template<> UNREALUSDWRAPPER_NON_ATTRIBUTED_API UEnum* StaticEnum<EUsdInterpolationType>();
...
template<> UNREALUSDWRAPPER_NON_ATTRIBUTED_API UEnum* StaticEnum<EUsdRootMotionHandling>();
// ********** End Enum EUsdRootMotionHandling ******************************************************

// ********** Begin Enum EUsdCollisionType *********************************************************
#define FOREACH_ENUM_EUSDCOLLISIONTYPE(op) \
	op(EUsdCollisionType::None) \
	op(EUsdCollisionType::ConvexDecomposition) \
	op(EUsdCollisionType::ConvexHull) \
	op(EUsdCollisionType::Sphere) \
	op(EUsdCollisionType::Cube) \
	op(EUsdCollisionType::MeshSimplification) \
	op(EUsdCollisionType::Capsule) \
	op(EUsdCollisionType::CustomMesh) 

enum class EUsdCollisionType : uint8;
template<> struct TIsUEnumClass<EUsdCollisionType> { enum { Value = true }; };
template<> UNREALUSDWRAPPER_NON_ATTRIBUTED_API UEnum* StaticEnum<EUsdCollisionType>();
// ********** End Enum EUsdCollisionType ***********************************************************
...
template<> UNREALUSDWRAPPER_NON_ATTRIBUTED_API UEnum* StaticEnum<EGeometryCacheImport>();
...
template<> UNREALUSDWRAPPER_NON_ATTRIBUTED_API UEnum* StaticEnum<EUsdListPosition>();
