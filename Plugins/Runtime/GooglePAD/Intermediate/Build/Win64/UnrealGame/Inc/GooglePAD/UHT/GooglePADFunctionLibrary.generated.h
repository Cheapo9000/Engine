...
#define FID_Engine_Plugins_Runtime_GooglePAD_Source_GooglePAD_Classes_GooglePADFunctionLibrary_h_173_RPC_WRAPPERS_NO_PURE_DECLS \
	...
	DECLARE_FUNCTION(execGetShowConfirmationDialogStatus); \
	DECLARE_FUNCTION(execShowConfirmationDialog); \
...
#define FID_Engine_Plugins_Runtime_GooglePAD_Source_GooglePAD_Classes_GooglePADFunctionLibrary_h_173_INCLASS_NO_PURE_DECLS \
private: \
	...
	friend GOOGLEPAD_API UClass* ::Z_Construct_UClass_UGooglePADFunctionLibrary_NoRegister(); \
public: \
	DECLARE_CLASS2(UGooglePADFunctionLibrary, UBlueprintFunctionLibrary, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/GooglePAD"), Z_Construct_UClass_UGooglePADFunctionLibrary_NoRegister) \
	DECLARE_SERIALIZER(UGooglePADFunctionLibrary)


#define FID_Engine_Plugins_Runtime_GooglePAD_Source_GooglePAD_Classes_GooglePADFunctionLibrary_h_173_ENHANCED_CONSTRUCTORS \
	/** Standard constructor, called after all reflected properties have been initialized */ \
	GOOGLEPAD_API UGooglePADFunctionLibrary(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
	/** Deleted move- and copy-constructors, should never be used */ \
	UGooglePADFunctionLibrary(UGooglePADFunctionLibrary&&) = delete; \
	UGooglePADFunctionLibrary(const UGooglePADFunctionLibrary&) = delete; \
	DECLARE_VTABLE_PTR_HELPER_CTOR(GOOGLEPAD_API, UGooglePADFunctionLibrary); \
	...
	GOOGLEPAD_API virtual ~UGooglePADFunctionLibrary();
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS \
public: \
	FID_Engine_Plugins_Runtime_GooglePAD_Source_GooglePAD_Classes_GooglePADFunctionLibrary_h_173_RPC_WRAPPERS_NO_PURE_DECLS \
...
#define FOREACH_ENUM_EGOOGLEPADERRORCODE(op) \
	...
	op(EGooglePADErrorCode::AssetPack_APP_NOT_OWNED) \
	op(EGooglePADErrorCode::AssetPack_CONFIRMATION_NOT_REQUIRED) \
	op(EGooglePADErrorCode::AssetPack_UNRECOGNIZED_INSTALLATION) 

enum class EGooglePADErrorCode : uint8;
template<> struct TIsUEnumClass<EGooglePADErrorCode> { enum { Value = true }; };
template<> GOOGLEPAD_NON_ATTRIBUTED_API UEnum* StaticEnum<EGooglePADErrorCode>();
...
template<> GOOGLEPAD_NON_ATTRIBUTED_API UEnum* StaticEnum<EGooglePADDownloadStatus>();
...
template<> GOOGLEPAD_NON_ATTRIBUTED_API UEnum* StaticEnum<EGooglePADStorageMethod>();
...
template<> GOOGLEPAD_NON_ATTRIBUTED_API UEnum* StaticEnum<EGooglePADCellularDataConfirmStatus>();
// ********** End Enum EGooglePADCellularDataConfirmStatus *****************************************

// ********** Begin Enum EGooglePADConfirmationDialogStatus ****************************************
#define FOREACH_ENUM_EGOOGLEPADCONFIRMATIONDIALOGSTATUS(op) \
	op(EGooglePADConfirmationDialogStatus::AssetPack_CONFIRMATION_DIALOG_UNKNOWN) \
	op(EGooglePADConfirmationDialogStatus::AssetPack_CONFIRMATION_DIALOG_PENDING) \
	op(EGooglePADConfirmationDialogStatus::AssetPack_CONFIRMATION_DIALOG_APPROVED) \
	op(EGooglePADConfirmationDialogStatus::AssetPack_CONFIRMATION_DIALOG_CANCELED) 

enum class EGooglePADConfirmationDialogStatus : uint8;
template<> struct TIsUEnumClass<EGooglePADConfirmationDialogStatus> { enum { Value = true }; };
template<> GOOGLEPAD_NON_ATTRIBUTED_API UEnum* StaticEnum<EGooglePADConfirmationDialogStatus>();
