...
// ********** Begin Enum ESimplifyTargetType *******************************************************
...
template<> MODELINGOPERATORSEDITORONLY_NON_ATTRIBUTED_API UEnum* StaticEnum<ESimplifyTargetType>();
// ********** End Enum ESimplifyTargetType *********************************************************

// ********** Begin Enum ESimplifyType *************************************************************
#define FOREACH_ENUM_ESIMPLIFYTYPE(op) \
	...
	op(ESimplifyType::ClusterBased) 

enum class ESimplifyType : uint8;
template<> struct TIsUEnumClass<ESimplifyType> { enum { Value = true }; };
template<> MODELINGOPERATORSEDITORONLY_NON_ATTRIBUTED_API UEnum* StaticEnum<ESimplifyType>();
// ********** End Enum ESimplifyType ***************************************************************
