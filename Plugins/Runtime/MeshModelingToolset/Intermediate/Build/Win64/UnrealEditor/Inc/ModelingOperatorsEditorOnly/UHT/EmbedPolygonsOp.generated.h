...
// ********** Begin Enum EEmbeddedPolygonOpMethod **************************************************
#define FOREACH_ENUM_EEMBEDDEDPOLYGONOPMETHOD(op) \
	...
	op(EEmbeddedPolygonOpMethod::CutOutside) 

enum class EEmbeddedPolygonOpMethod : uint8;
template<> struct TIsUEnumClass<EEmbeddedPolygonOpMethod> { enum { Value = true }; };
template<> MODELINGOPERATORSEDITORONLY_NON_ATTRIBUTED_API UEnum* StaticEnum<EEmbeddedPolygonOpMethod>();
// ********** End Enum EEmbeddedPolygonOpMethod ****************************************************
