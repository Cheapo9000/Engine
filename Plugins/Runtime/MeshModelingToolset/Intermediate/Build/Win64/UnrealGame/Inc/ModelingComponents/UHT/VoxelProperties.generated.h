...
private: \
	...
	friend MODELINGCOMPONENTS_API UClass* ::Z_Construct_UClass_UVoxelProperties_NoRegister(); \
public: \
	DECLARE_CLASS2(UVoxelProperties, UInteractiveToolPropertySet, COMPILED_IN_FLAGS(0 | CLASS_Transient), CASTCLASS_None, TEXT("/Script/ModelingComponents"), Z_Construct_UClass_UVoxelProperties_NoRegister) \
...
#define FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_PropertySets_VoxelProperties_h_16_ENHANCED_CONSTRUCTORS \
	...
	MODELINGCOMPONENTS_API UVoxelProperties(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
	/** Deleted move- and copy-constructors, should never be used */ \
	UVoxelProperties(UVoxelProperties&&) = delete; \
	UVoxelProperties(const UVoxelProperties&) = delete; \
	DECLARE_VTABLE_PTR_HELPER_CTOR(MODELINGCOMPONENTS_API, UVoxelProperties); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UVoxelProperties); \
	DEFINE_DEFAULT_OBJECT_INITIALIZER_CONSTRUCTOR_CALL(UVoxelProperties) \
	MODELINGCOMPONENTS_API virtual ~UVoxelProperties();
