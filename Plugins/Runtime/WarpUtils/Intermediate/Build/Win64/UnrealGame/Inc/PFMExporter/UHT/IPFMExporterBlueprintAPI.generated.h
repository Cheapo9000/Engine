...
// ********** Begin Interface UPFMExporterBlueprintAPI *********************************************
...
#define FID_Engine_Plugins_Runtime_WarpUtils_Source_PFMExporter_Public_Blueprints_IPFMExporterBlueprintAPI_h_17_ENHANCED_CONSTRUCTORS \
	...
	UPFMExporterBlueprintAPI(UPFMExporterBlueprintAPI&&) = delete; \
	UPFMExporterBlueprintAPI(const UPFMExporterBlueprintAPI&) = delete; \
	...
	virtual ~UPFMExporterBlueprintAPI() = default;
...
private: \
	...
	friend PFMEXPORTER_API UClass* ::Z_Construct_UClass_UPFMExporterBlueprintAPI_NoRegister(); \
public: \
	DECLARE_CLASS2(UPFMExporterBlueprintAPI, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/PFMExporter"), Z_Construct_UClass_UPFMExporterBlueprintAPI_NoRegister) \
...
class UPFMExporterBlueprintAPI;

// ********** End Interface UPFMExporterBlueprintAPI ***********************************************
