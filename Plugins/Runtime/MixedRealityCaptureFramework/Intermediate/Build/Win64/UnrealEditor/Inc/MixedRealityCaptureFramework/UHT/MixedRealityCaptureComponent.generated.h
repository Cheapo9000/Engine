...
// ********** Begin Delegate FMRCaptureFeedOpenedDelegate ******************************************
...
// ********** End Delegate FMRCaptureFeedOpenedDelegate ********************************************

// ********** Begin Class UMixedRealityCaptureComponent ********************************************
...
private: \
	...
	friend MIXEDREALITYCAPTUREFRAMEWORK_API UClass* ::Z_Construct_UClass_UMixedRealityCaptureComponent_NoRegister(); \
public: \
	DECLARE_CLASS2(UMixedRealityCaptureComponent, USceneCaptureComponent2D, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/MixedRealityCaptureFramework"), Z_Construct_UClass_UMixedRealityCaptureComponent_NoRegister) \
...
#define FID_Engine_Plugins_Runtime_MixedRealityCaptureFramework_Source_MixedRealityCaptureFramework_Public_MixedRealityCaptureComponent_h_37_STANDARD_CONSTRUCTORS \
	...
	UMixedRealityCaptureComponent(UMixedRealityCaptureComponent&&) = delete; \
	UMixedRealityCaptureComponent(const UMixedRealityCaptureComponent&) = delete; \
...
// ********** End Class UMixedRealityCaptureComponent **********************************************
