...
// ********** Begin Class UMrcGarbageMatteCaptureComponent *****************************************
...
private: \
	...
	friend MIXEDREALITYCAPTUREFRAMEWORK_API UClass* ::Z_Construct_UClass_UMrcGarbageMatteCaptureComponent_NoRegister(); \
public: \
	DECLARE_CLASS2(UMrcGarbageMatteCaptureComponent, USceneCaptureComponent2D, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/MixedRealityCaptureFramework"), Z_Construct_UClass_UMrcGarbageMatteCaptureComponent_NoRegister) \
...
#define FID_Engine_Plugins_Runtime_MixedRealityCaptureFramework_Source_MixedRealityCaptureFramework_Public_MrcGarbageMatteCaptureComponent_h_20_STANDARD_CONSTRUCTORS \
	...
	UMrcGarbageMatteCaptureComponent(UMrcGarbageMatteCaptureComponent&&) = delete; \
	UMrcGarbageMatteCaptureComponent(const UMrcGarbageMatteCaptureComponent&) = delete; \
...
// ********** End Class UMrcGarbageMatteCaptureComponent *******************************************

// ********** Begin Class AMrcGarbageMatteActor ****************************************************
...
private: \
	...
	static UClass* GetPrivateStaticClass(); \
	friend MIXEDREALITYCAPTUREFRAMEWORK_API UClass* ::Z_Construct_UClass_AMrcGarbageMatteActor_NoRegister(); \
public: \
	DECLARE_CLASS2(AMrcGarbageMatteActor, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/MixedRealityCaptureFramework"), Z_Construct_UClass_AMrcGarbageMatteActor_NoRegister) \
...
#define FID_Engine_Plugins_Runtime_MixedRealityCaptureFramework_Source_MixedRealityCaptureFramework_Public_MrcGarbageMatteCaptureComponent_h_81_STANDARD_CONSTRUCTORS \
	...
	/** Deleted move- and copy-constructors, should never be used */ \
	AMrcGarbageMatteActor(AMrcGarbageMatteActor&&) = delete; \
	AMrcGarbageMatteActor(const AMrcGarbageMatteActor&) = delete; \
...
// ********** End Class AMrcGarbageMatteActor ******************************************************
