...
// ********** Begin Interface UDMXMVRFixtureActorInterface *****************************************
...
#define FID_Engine_Plugins_VirtualProduction_DMX_DMXModularFeatures_Source_DMXFixtureActorInterface_Public_DMXMVRFixtureActorInterface_h_22_ENHANCED_CONSTRUCTORS \
	...
	UDMXMVRFixtureActorInterface(UDMXMVRFixtureActorInterface&&) = delete; \
	UDMXMVRFixtureActorInterface(const UDMXMVRFixtureActorInterface&) = delete; \
	...
	virtual ~UDMXMVRFixtureActorInterface() = default;
...
private: \
	...
	friend DMXFIXTUREACTORINTERFACE_API UClass* ::Z_Construct_UClass_UDMXMVRFixtureActorInterface_NoRegister(); \
public: \
	DECLARE_CLASS2(UDMXMVRFixtureActorInterface, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/DMXFixtureActorInterface"), Z_Construct_UClass_UDMXMVRFixtureActorInterface_NoRegister) \
...
class UDMXMVRFixtureActorInterface;

// ********** End Interface UDMXMVRFixtureActorInterface *******************************************
