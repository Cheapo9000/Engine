...
private: \
	...
	friend DMXRUNTIME_API UClass* ::Z_Construct_UClass_UDMXObjectBase_NoRegister(); \
public: \
	DECLARE_CLASS2(UDMXObjectBase, UObject, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/DMXRuntime"), Z_Construct_UClass_UDMXObjectBase_NoRegister) \
...
#define FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_Library_DMXObjectBase_h_13_ENHANCED_CONSTRUCTORS \
	...
	UDMXObjectBase(UDMXObjectBase&&) = delete; \
	UDMXObjectBase(const UDMXObjectBase&) = delete; \
...
class UDMXObjectBase;

// ********** End Class UDMXObjectBase *************************************************************
