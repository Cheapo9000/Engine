...
// ********** Begin Class USwitchboardProjectSettings **********************************************
...
private: \
	...
	friend SWITCHBOARDEDITOR_API UClass* ::Z_Construct_UClass_USwitchboardProjectSettings_NoRegister(); \
public: \
	DECLARE_CLASS2(USwitchboardProjectSettings, UObject, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/SwitchboardEditor"), Z_Construct_UClass_USwitchboardProjectSettings_NoRegister) \
...
#define FID_Engine_Plugins_VirtualProduction_Switchboard_Source_SwitchboardEditor_Public_SwitchboardProjectSettings_h_17_ENHANCED_CONSTRUCTORS \
	...
	USwitchboardProjectSettings(USwitchboardProjectSettings&&) = delete; \
	USwitchboardProjectSettings(const USwitchboardProjectSettings&) = delete; \
...
// ********** End Class USwitchboardProjectSettings ************************************************
