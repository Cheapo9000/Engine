...
// ********** Begin ScriptStruct FDMMaterialStageConnectorChannel **********************************
struct Z_Construct_UScriptStruct_FDMMaterialStageConnectorChannel_Statics;
#define FID_Engine_Plugins_VirtualProduction_DynamicMaterial_Source_DynamicMaterial_Public_DMDefs_h_115_GENERATED_BODY \
...
// ********** End ScriptStruct FDMMaterialStageConnectorChannel ************************************

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID FID_Engine_Plugins_VirtualProduction_DynamicMaterial_Source_DynamicMaterial_Public_DMDefs_h

// ********** Begin Enum EDMMaterialPropertyType ***************************************************
...
template<> DYNAMICMATERIAL_NON_ATTRIBUTED_API UEnum* StaticEnum<EDMMaterialPropertyType>();
// ********** End Enum EDMMaterialPropertyType *****************************************************

// ********** Begin Enum EDMValueType **************************************************************
...
template<> DYNAMICMATERIAL_NON_ATTRIBUTED_API UEnum* StaticEnum<EDMValueType>();
// ********** End Enum EDMValueType ****************************************************************

// ********** Begin Enum EDMUpdateType *************************************************************
#define FOREACH_ENUM_EDMUPDATETYPE(op) \
	op(EDMUpdateType::Value) \
	op(EDMUpdateType::Structure) \
	op(EDMUpdateType::AllowParentUpdate) \
	op(EDMUpdateType::RefreshDetailView) 

enum class EDMUpdateType : uint8;
template<> struct TIsUEnumClass<EDMUpdateType> { enum { Value = true }; };
template<> DYNAMICMATERIAL_NON_ATTRIBUTED_API UEnum* StaticEnum<EDMUpdateType>();
// ********** End Enum EDMUpdateType ***************************************************************

// ********** Begin Enum EDMMaterialShadingModel ***************************************************
...
template<> DYNAMICMATERIAL_NON_ATTRIBUTED_API UEnum* StaticEnum<EDMMaterialShadingModel>();
// ********** End Enum EDMMaterialShadingModel *****************************************************

// ********** Begin Enum EDMUVSource ***************************************************************
...
template<> DYNAMICMATERIAL_NON_ATTRIBUTED_API UEnum* StaticEnum<EDMUVSource>();
// ********** End Enum EDMUVSource *****************************************************************

// ********** Begin Enum EDMLocationType ***********************************************************
...
template<> DYNAMICMATERIAL_NON_ATTRIBUTED_API UEnum* StaticEnum<EDMLocationType>();
// ********** End Enum EDMLocationType *************************************************************
