...
#define CURRENT_FILE_ID FID_Engine_Plugins_PCG_Source_PCG_Public_Metadata_PCGMetadataAttributeTraits_h

// ********** Begin Enum EPCGMetadataTypes *********************************************************
#define FOREACH_ENUM_EPCGMETADATATYPES(op) \
	...
	op(EPCGMetadataTypes::SoftObjectPath) \
	op(EPCGMetadataTypes::SoftClassPath) \
...
template<> PCG_NON_ATTRIBUTED_API UEnum* StaticEnum<EPCGMetadataTypes>();
// ********** End Enum EPCGMetadataTypes ***********************************************************
