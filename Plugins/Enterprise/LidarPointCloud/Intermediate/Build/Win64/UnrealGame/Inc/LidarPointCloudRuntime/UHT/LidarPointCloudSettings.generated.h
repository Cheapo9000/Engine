...
// ********** Begin Class ULidarPointCloudSettings *************************************************
...
private: \
	...
	friend LIDARPOINTCLOUDRUNTIME_API UClass* ::Z_Construct_UClass_ULidarPointCloudSettings_NoRegister(); \
public: \
	DECLARE_CLASS2(ULidarPointCloudSettings, UObject, COMPILED_IN_FLAGS(0 | CLASS_DefaultConfig | CLASS_Config), CASTCLASS_None, TEXT("/Script/LidarPointCloudRuntime"), Z_Construct_UClass_ULidarPointCloudSettings_NoRegister) \
...
#define FID_Engine_Plugins_Enterprise_LidarPointCloud_Source_LidarPointCloudRuntime_Public_LidarPointCloudSettings_h_23_ENHANCED_CONSTRUCTORS \
	...
	ULidarPointCloudSettings(ULidarPointCloudSettings&&) = delete; \
	ULidarPointCloudSettings(const ULidarPointCloudSettings&) = delete; \
...
class ULidarPointCloudSettings;

// ********** End Class ULidarPointCloudSettings ***************************************************
...
// ********** Begin Enum ELidarPointCloudDuplicateHandling *****************************************
...
template<> LIDARPOINTCLOUDRUNTIME_NON_ATTRIBUTED_API UEnum* StaticEnum<ELidarPointCloudDuplicateHandling>();
// ********** End Enum ELidarPointCloudDuplicateHandling *******************************************
