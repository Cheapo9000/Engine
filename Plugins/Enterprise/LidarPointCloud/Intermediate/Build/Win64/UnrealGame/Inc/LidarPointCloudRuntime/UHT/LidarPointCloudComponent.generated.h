...
// ********** Begin Class ULidarPointCloudComponent ************************************************
#define FID_Engine_Plugins_Enterprise_LidarPointCloud_Source_LidarPointCloudRuntime_Public_LidarPointCloudComponent_h_26_RPC_WRAPPERS_NO_PURE_DECLS \
	...
	DECLARE_FUNCTION(execGetSelectedPointsAsCopies); \
...
private: \
	...
	friend LIDARPOINTCLOUDRUNTIME_API UClass* ::Z_Construct_UClass_ULidarPointCloudComponent_NoRegister(); \
public: \
	DECLARE_CLASS2(ULidarPointCloudComponent, UMeshComponent, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/LidarPointCloudRuntime"), Z_Construct_UClass_ULidarPointCloudComponent_NoRegister) \
...
#define FID_Engine_Plugins_Enterprise_LidarPointCloud_Source_LidarPointCloudRuntime_Public_LidarPointCloudComponent_h_26_ENHANCED_CONSTRUCTORS \
	...
	ULidarPointCloudComponent(ULidarPointCloudComponent&&) = delete; \
	ULidarPointCloudComponent(const ULidarPointCloudComponent&) = delete; \
...
// ********** End Class ULidarPointCloudComponent **************************************************
...
// ********** Begin Enum ELidarPointCloudSpriteOrientation *****************************************
...
template<> LIDARPOINTCLOUDRUNTIME_NON_ATTRIBUTED_API UEnum* StaticEnum<ELidarPointCloudSpriteOrientation>();
// ********** End Enum ELidarPointCloudSpriteOrientation *******************************************
