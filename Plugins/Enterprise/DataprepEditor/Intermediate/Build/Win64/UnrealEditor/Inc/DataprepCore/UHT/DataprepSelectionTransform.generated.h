...
// ********** Begin Class UDataprepSelectionTransform **********************************************
...
private: \
	...
	friend DATAPREPCORE_API UClass* ::Z_Construct_UClass_UDataprepSelectionTransform_NoRegister(); \
public: \
	DECLARE_CLASS2(UDataprepSelectionTransform, UDataprepParameterizableObject, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/DataprepCore"), Z_Construct_UClass_UDataprepSelectionTransform_NoRegister) \
...
#define FID_Engine_Plugins_Enterprise_DataprepEditor_Source_DataprepCore_Public_SelectionSystem_DataprepSelectionTransform_h_18_ENHANCED_CONSTRUCTORS \
	...
	UDataprepSelectionTransform(UDataprepSelectionTransform&&) = delete; \
	UDataprepSelectionTransform(const UDataprepSelectionTransform&) = delete; \
...
// ********** End Class UDataprepSelectionTransform ************************************************

// ********** Begin Class UDataprepRecursiveSelectionTransform *************************************
...
private: \
	...
	static UClass* GetPrivateStaticClass(); \
	friend DATAPREPCORE_API UClass* ::Z_Construct_UClass_UDataprepRecursiveSelectionTransform_NoRegister(); \
public: \
	DECLARE_CLASS2(UDataprepRecursiveSelectionTransform, UDataprepSelectionTransform, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/DataprepCore"), Z_Construct_UClass_UDataprepRecursiveSelectionTransform_NoRegister) \
...
#define FID_Engine_Plugins_Enterprise_DataprepEditor_Source_DataprepCore_Public_SelectionSystem_DataprepSelectionTransform_h_87_ENHANCED_CONSTRUCTORS \
	...
	/** Deleted move- and copy-constructors, should never be used */ \
	UDataprepRecursiveSelectionTransform(UDataprepRecursiveSelectionTransform&&) = delete; \
	UDataprepRecursiveSelectionTransform(const UDataprepRecursiveSelectionTransform&) = delete; \
...
class UDataprepRecursiveSelectionTransform;

// ********** End Class UDataprepRecursiveSelectionTransform ***************************************
