...
private: \
	...
	friend WORLDMETRICSCORE_API UClass* ::Z_Construct_UClass_UWorldMetricInterface_NoRegister(); \
public: \
	DECLARE_CLASS2(UWorldMetricInterface, UObject, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/WorldMetricsCore"), Z_Construct_UClass_UWorldMetricInterface_NoRegister) \
...
#define FID_Engine_Plugins_WorldMetrics_Source_WorldMetricsCore_Public_WorldMetricInterface_h_17_ENHANCED_CONSTRUCTORS \
	...
	UWorldMetricInterface(UWorldMetricInterface&&) = delete; \
	UWorldMetricInterface(const UWorldMetricInterface&) = delete; \
