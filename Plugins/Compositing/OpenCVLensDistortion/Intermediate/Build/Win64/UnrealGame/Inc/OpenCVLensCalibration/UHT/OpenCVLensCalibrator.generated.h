...
// ********** Begin Class UOpenCVLensCalibrator ****************************************************
...
private: \
	...
	friend OPENCVLENSCALIBRATION_API UClass* ::Z_Construct_UClass_UOpenCVLensCalibrator_NoRegister(); \
public: \
	DECLARE_CLASS2(UOpenCVLensCalibrator, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/OpenCVLensCalibration"), Z_Construct_UClass_UOpenCVLensCalibrator_NoRegister) \
...
#define FID_Engine_Plugins_Compositing_OpenCVLensDistortion_Source_OpenCVLensCalibration_Private_OpenCVLensCalibrator_h_26_ENHANCED_CONSTRUCTORS \
	...
	UOpenCVLensCalibrator(UOpenCVLensCalibrator&&) = delete; \
	UOpenCVLensCalibrator(const UOpenCVLensCalibrator&) = delete; \
...
// ********** End Class UOpenCVLensCalibrator ******************************************************
