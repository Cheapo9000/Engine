...
// ********** Begin Delegate FDynamicOnTransformPassRendered ***************************************
...
// ********** End Delegate FDynamicOnTransformPassRendered *****************************************

// ********** Begin Delegate FDynamicOnFinalPassRendered *******************************************
...
// ********** End Delegate FDynamicOnFinalPassRendered *********************************************

// ********** Begin Class ACompositingElement ******************************************************
...
private: \
	...
	friend COMPOSURE_API UClass* ::Z_Construct_UClass_ACompositingElement_NoRegister(); \
public: \
	DECLARE_CLASS2(ACompositingElement, AComposurePipelineBaseActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Composure"), Z_Construct_UClass_ACompositingElement_NoRegister) \
...
#define FID_Engine_Plugins_Compositing_Composure_Source_Composure_Classes_CompositingElement_h_78_STANDARD_CONSTRUCTORS \
	...
	ACompositingElement(ACompositingElement&&) = delete; \
	ACompositingElement(const ACompositingElement&) = delete; \
...
template<> COMPOSURE_NON_ATTRIBUTED_API UEnum* StaticEnum<ESceneCameraLinkType>();
// ********** End Enum ESceneCameraLinkType ********************************************************

// ********** Begin Enum EInheritedSourceType ******************************************************
...
template<> COMPOSURE_NON_ATTRIBUTED_API UEnum* StaticEnum<EInheritedSourceType>();
// ********** End Enum EInheritedSourceType ********************************************************

// ********** Begin Enum ETargetUsageFlags *********************************************************
...
template<> COMPOSURE_NON_ATTRIBUTED_API UEnum* StaticEnum<ETargetUsageFlags>();
// ********** End Enum ETargetUsageFlags ***********************************************************

// ********** Begin Enum ECompPassConstructionType *************************************************
...
template<> COMPOSURE_NON_ATTRIBUTED_API UEnum* StaticEnum<ECompPassConstructionType>();
// ********** End Enum ECompPassConstructionType ***************************************************
