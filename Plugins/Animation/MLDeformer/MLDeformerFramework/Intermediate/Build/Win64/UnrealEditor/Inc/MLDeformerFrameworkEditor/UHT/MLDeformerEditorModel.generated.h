...
#define FOREACH_ENUM_ETRAININGRESULT(op) \
	...
	op(ETrainingResult::Other) 

enum class ETrainingResult : uint8;
template<> struct TIsUEnumClass<ETrainingResult> { enum { Value = true }; };
template<> MLDEFORMERFRAMEWORKEDITOR_NON_ATTRIBUTED_API UEnum* StaticEnum<ETrainingResult>();
// ********** End Enum ETrainingResult *************************************************************
