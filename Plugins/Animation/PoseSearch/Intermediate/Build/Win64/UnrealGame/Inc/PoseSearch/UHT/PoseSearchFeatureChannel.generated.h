...
template<> POSESEARCH_NON_ATTRIBUTED_API UEnum* StaticEnum<EComponentStrippingVector>();
...
template<> POSESEARCH_NON_ATTRIBUTED_API UEnum* StaticEnum<EInputQueryPose>();
...
template<> POSESEARCH_NON_ATTRIBUTED_API UEnum* StaticEnum<EPermutationTimeType>();
