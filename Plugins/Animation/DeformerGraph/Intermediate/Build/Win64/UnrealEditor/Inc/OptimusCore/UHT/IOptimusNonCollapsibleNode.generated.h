...
#define FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_IOptimusNonCollapsibleNode_h_13_ENHANCED_CONSTRUCTORS \
	...
	OPTIMUSCORE_API UOptimusNonCollapsibleNode(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
	/** Deleted move- and copy-constructors, should never be used */ \
	UOptimusNonCollapsibleNode(UOptimusNonCollapsibleNode&&) = delete; \
	UOptimusNonCollapsibleNode(const UOptimusNonCollapsibleNode&) = delete; \
	DECLARE_VTABLE_PTR_HELPER_CTOR(OPTIMUSCORE_API, UOptimusNonCollapsibleNode); \
	...
	virtual ~UOptimusNonCollapsibleNode() = default;
...
private: \
	...
	friend OPTIMUSCORE_API UClass* ::Z_Construct_UClass_UOptimusNonCollapsibleNode_NoRegister(); \
public: \
	DECLARE_CLASS2(UOptimusNonCollapsibleNode, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/OptimusCore"), Z_Construct_UClass_UOptimusNonCollapsibleNode_NoRegister) \
