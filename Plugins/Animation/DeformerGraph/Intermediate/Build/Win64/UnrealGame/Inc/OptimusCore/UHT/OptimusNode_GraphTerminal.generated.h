...
private: \
	...
	friend OPTIMUSCORE_API UClass* ::Z_Construct_UClass_UOptimusNode_GraphTerminal_NoRegister(); \
public: \
	DECLARE_CLASS2(UOptimusNode_GraphTerminal, UOptimusNode, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/OptimusCore"), Z_Construct_UClass_UOptimusNode_GraphTerminal_NoRegister) \
...
#define FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_Nodes_OptimusNode_GraphTerminal_h_33_ENHANCED_CONSTRUCTORS \
	...
	UOptimusNode_GraphTerminal(UOptimusNode_GraphTerminal&&) = delete; \
	UOptimusNode_GraphTerminal(const UOptimusNode_GraphTerminal&) = delete; \
...
template<> OPTIMUSCORE_NON_ATTRIBUTED_API UEnum* StaticEnum<EOptimusTerminalType>();
