...
private: \
	...
	friend OPTIMUSCORE_API UClass* ::Z_Construct_UClass_UOptimusGraphDataInterface_NoRegister(); \
public: \
	DECLARE_CLASS2(UOptimusGraphDataInterface, UComputeDataInterface, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/OptimusCore"), Z_Construct_UClass_UOptimusGraphDataInterface_NoRegister) \
...
#define FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_DataInterfaces_OptimusDataInterfaceGraph_h_57_ENHANCED_CONSTRUCTORS \
	...
	UOptimusGraphDataInterface(UOptimusGraphDataInterface&&) = delete; \
	UOptimusGraphDataInterface(const UOptimusGraphDataInterface&) = delete; \
...
private: \
	...
	static UClass* GetPrivateStaticClass(); \
	friend OPTIMUSCORE_API UClass* ::Z_Construct_UClass_UOptimusGraphDataProvider_NoRegister(); \
public: \
	DECLARE_CLASS2(UOptimusGraphDataProvider, UComputeDataProvider, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/OptimusCore"), Z_Construct_UClass_UOptimusGraphDataProvider_NoRegister) \
...
#define FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_DataInterfaces_OptimusDataInterfaceGraph_h_91_ENHANCED_CONSTRUCTORS \
	...
	/** Deleted move- and copy-constructors, should never be used */ \
	UOptimusGraphDataProvider(UOptimusGraphDataProvider&&) = delete; \
	UOptimusGraphDataProvider(const UOptimusGraphDataProvider&) = delete; \
