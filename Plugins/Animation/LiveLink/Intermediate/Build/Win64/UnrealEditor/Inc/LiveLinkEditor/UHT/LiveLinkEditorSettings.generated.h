...
// ********** Begin Class ULiveLinkEditorSettings **************************************************
struct Z_Construct_UClass_ULiveLinkEditorSettings_Statics;
LIVELINKEDITOR_API UClass* Z_Construct_UClass_ULiveLinkEditorSettings_NoRegister();
...
private: \
	...
	friend LIVELINKEDITOR_API UClass* ::Z_Construct_UClass_ULiveLinkEditorSettings_NoRegister(); \
public: \
	DECLARE_CLASS2(ULiveLinkEditorSettings, UObject, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/LiveLinkEditor"), Z_Construct_UClass_ULiveLinkEditorSettings_NoRegister) \
...
#define FID_Engine_Plugins_Animation_LiveLink_Source_LiveLinkEditor_Public_LiveLinkEditorSettings_h_15_ENHANCED_CONSTRUCTORS \
	...
	LIVELINKEDITOR_API ULiveLinkEditorSettings(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
	/** Deleted move- and copy-constructors, should never be used */ \
	ULiveLinkEditorSettings(ULiveLinkEditorSettings&&) = delete; \
	ULiveLinkEditorSettings(const ULiveLinkEditorSettings&) = delete; \
	DECLARE_VTABLE_PTR_HELPER_CTOR(LIVELINKEDITOR_API, ULiveLinkEditorSettings); \
	...
	LIVELINKEDITOR_API virtual ~ULiveLinkEditorSettings();
...
class ULiveLinkEditorSettings;

// ********** End Class ULiveLinkEditorSettings ****************************************************
