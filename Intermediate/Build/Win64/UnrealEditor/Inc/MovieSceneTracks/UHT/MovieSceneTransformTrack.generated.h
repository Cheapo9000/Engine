...
private: \
	...
	friend MOVIESCENETRACKS_API UClass* ::Z_Construct_UClass_UMovieSceneTransformTrack_NoRegister(); \
public: \
	DECLARE_CLASS2(UMovieSceneTransformTrack, UMovieScenePropertyTrack, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/MovieSceneTracks"), Z_Construct_UClass_UMovieSceneTransformTrack_NoRegister) \
...
#define FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneTransformTrack_h_19_STANDARD_CONSTRUCTORS \
	...
	UMovieSceneTransformTrack(UMovieSceneTransformTrack&&) = delete; \
	UMovieSceneTransformTrack(const UMovieSceneTransformTrack&) = delete; \
