...
private: \
	...
	friend MOVIESCENETRACKS_API UClass* ::Z_Construct_UClass_UMovieScenePropertySystem_NoRegister(); \
public: \
	DECLARE_CLASS2(UMovieScenePropertySystem, UMovieSceneEntitySystem, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/MovieSceneTracks"), Z_Construct_UClass_UMovieScenePropertySystem_NoRegister) \
...
#define FID_Engine_Source_Runtime_MovieSceneTracks_Public_Systems_MovieScenePropertySystem_h_21_ENHANCED_CONSTRUCTORS \
	...
	UMovieScenePropertySystem(UMovieScenePropertySystem&&) = delete; \
	UMovieScenePropertySystem(const UMovieScenePropertySystem&) = delete; \
