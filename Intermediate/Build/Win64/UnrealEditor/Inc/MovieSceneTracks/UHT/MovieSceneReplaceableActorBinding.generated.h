...
private: \
	...
	friend MOVIESCENETRACKS_API UClass* ::Z_Construct_UClass_UMovieSceneReplaceableActorBinding_NoRegister(); \
public: \
	DECLARE_CLASS2(UMovieSceneReplaceableActorBinding, UMovieSceneReplaceableBindingBase, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/MovieSceneTracks"), Z_Construct_UClass_UMovieSceneReplaceableActorBinding_NoRegister) \
...
#define FID_Engine_Source_Runtime_MovieSceneTracks_Public_Bindings_MovieSceneReplaceableActorBinding_h_20_ENHANCED_CONSTRUCTORS \
	...
	UMovieSceneReplaceableActorBinding(UMovieSceneReplaceableActorBinding&&) = delete; \
	UMovieSceneReplaceableActorBinding(const UMovieSceneReplaceableActorBinding&) = delete; \
...
private: \
	...
	static UClass* GetPrivateStaticClass(); \
	friend MOVIESCENETRACKS_API UClass* ::Z_Construct_UClass_UMovieSceneReplaceableActorBinding_BPBase_NoRegister(); \
public: \
	DECLARE_CLASS2(UMovieSceneReplaceableActorBinding_BPBase, UMovieSceneReplaceableBindingBase, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/MovieSceneTracks"), Z_Construct_UClass_UMovieSceneReplaceableActorBinding_BPBase_NoRegister) \
...
#define FID_Engine_Source_Runtime_MovieSceneTracks_Public_Bindings_MovieSceneReplaceableActorBinding_h_56_ENHANCED_CONSTRUCTORS \
	...
	/** Deleted move- and copy-constructors, should never be used */ \
	UMovieSceneReplaceableActorBinding_BPBase(UMovieSceneReplaceableActorBinding_BPBase&&) = delete; \
	UMovieSceneReplaceableActorBinding_BPBase(const UMovieSceneReplaceableActorBinding_BPBase&) = delete; \
