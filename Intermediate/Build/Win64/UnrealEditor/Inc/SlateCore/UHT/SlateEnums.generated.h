...
template<> SLATECORE_NON_ATTRIBUTED_API UEnum* StaticEnum<EButtonClickMethod::Type>();
// ********** End Enum EButtonClickMethod **********************************************************

// ********** Begin Enum EButtonTouchMethod ********************************************************
...
template<> SLATECORE_NON_ATTRIBUTED_API UEnum* StaticEnum<EButtonTouchMethod::Type>();
// ********** End Enum EButtonTouchMethod **********************************************************

// ********** Begin Enum EButtonPressMethod ********************************************************
...
template<> SLATECORE_NON_ATTRIBUTED_API UEnum* StaticEnum<EButtonPressMethod::Type>();
// ********** End Enum EButtonPressMethod **********************************************************

// ********** Begin Enum EUINavigation *************************************************************
...
template<> SLATECORE_NON_ATTRIBUTED_API UEnum* StaticEnum<EUINavigation>();
// ********** End Enum EUINavigation ***************************************************************

// ********** Begin Enum EUINavigationAction *******************************************************
...
template<> SLATECORE_NON_ATTRIBUTED_API UEnum* StaticEnum<EUINavigationAction>();
// ********** End Enum EUINavigationAction *********************************************************

// ********** Begin Enum ENavigationSource *********************************************************
...
template<> SLATECORE_NON_ATTRIBUTED_API UEnum* StaticEnum<ENavigationSource>();
// ********** End Enum ENavigationSource ***********************************************************

// ********** Begin Enum ENavigationGenesis ********************************************************
...
template<> SLATECORE_NON_ATTRIBUTED_API UEnum* StaticEnum<ENavigationGenesis>();
// ********** End Enum ENavigationGenesis **********************************************************

// ********** Begin Enum EHorizontalAlignment ******************************************************
...
template<> SLATECORE_NON_ATTRIBUTED_API UEnum* StaticEnum<EHorizontalAlignment>();
// ********** End Enum EHorizontalAlignment ********************************************************

// ********** Begin Enum EVerticalAlignment ********************************************************
...
template<> SLATECORE_NON_ATTRIBUTED_API UEnum* StaticEnum<EVerticalAlignment>();
// ********** End Enum EVerticalAlignment **********************************************************

// ********** Begin Enum EMenuPlacement ************************************************************
...
template<> SLATECORE_NON_ATTRIBUTED_API UEnum* StaticEnum<EMenuPlacement>();
// ********** End Enum EMenuPlacement **************************************************************

// ********** Begin Enum EOrientation **************************************************************
#define FOREACH_ENUM_EORIENTATION(op) \
	op(Orient_Horizontal) \
	op(Orient_Vertical) 

enum EOrientation : int;
template<> SLATECORE_NON_ATTRIBUTED_API UEnum* StaticEnum<EOrientation>();
// ********** End Enum EOrientation ****************************************************************

// ********** Begin Enum EScrollDirection **********************************************************
#define FOREACH_ENUM_ESCROLLDIRECTION(op) \
	op(Scroll_Down) \
	op(Scroll_Up) 

enum EScrollDirection : int;
template<> SLATECORE_NON_ATTRIBUTED_API UEnum* StaticEnum<EScrollDirection>();
// ********** End Enum EScrollDirection ************************************************************

// ********** Begin Enum ETextCommit ***************************************************************
...
template<> SLATECORE_NON_ATTRIBUTED_API UEnum* StaticEnum<ETextCommit::Type>();
// ********** End Enum ETextCommit *****************************************************************

// ********** Begin Enum ESelectInfo ***************************************************************
...
template<> SLATECORE_NON_ATTRIBUTED_API UEnum* StaticEnum<ESelectInfo::Type>();
// ********** End Enum ESelectInfo *****************************************************************
