...
#define FID_Engine_Source_Runtime_TypedElementRuntime_Public_Elements_Interfaces_TypedElementHierarchyInterface_h_19_ENHANCED_CONSTRUCTORS \
	...
	UTypedElementHierarchyInterface(UTypedElementHierarchyInterface&&) = delete; \
	UTypedElementHierarchyInterface(const UTypedElementHierarchyInterface&) = delete; \
	...
	virtual ~UTypedElementHierarchyInterface() = default;
...
private: \
	...
	friend TYPEDELEMENTRUNTIME_API UClass* ::Z_Construct_UClass_UTypedElementHierarchyInterface_NoRegister(); \
public: \
	DECLARE_CLASS2(UTypedElementHierarchyInterface, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/TypedElementRuntime"), Z_Construct_UClass_UTypedElementHierarchyInterface_NoRegister) \
...
class UTypedElementHierarchyInterface;
