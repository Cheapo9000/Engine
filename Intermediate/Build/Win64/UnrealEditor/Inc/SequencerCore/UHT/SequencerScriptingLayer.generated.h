...
// ********** Begin Class USequencerScriptingLayer *************************************************
struct Z_Construct_UClass_USequencerScriptingLayer_Statics;
...
private: \
	...
	friend SEQUENCERCORE_API UClass* ::Z_Construct_UClass_USequencerScriptingLayer_NoRegister(); \
public: \
	DECLARE_CLASS2(USequencerScriptingLayer, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/SequencerCore"), Z_Construct_UClass_USequencerScriptingLayer_NoRegister) \
...
#define FID_Engine_Source_Editor_SequencerCore_Public_Scripting_SequencerScriptingLayer_h_22_ENHANCED_CONSTRUCTORS \
	...
	USequencerScriptingLayer(USequencerScriptingLayer&&) = delete; \
	USequencerScriptingLayer(const USequencerScriptingLayer&) = delete; \
...
// ********** End Class USequencerScriptingLayer ***************************************************
