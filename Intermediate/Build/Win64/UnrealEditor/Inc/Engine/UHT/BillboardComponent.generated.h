...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UBillboardComponent_NoRegister(); \
public: \
	DECLARE_CLASS2(UBillboardComponent, UPrimitiveComponent, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UBillboardComponent_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Components_BillboardComponent_h_21_STANDARD_CONSTRUCTORS \
	...
	UBillboardComponent(UBillboardComponent&&) = delete; \
	UBillboardComponent(const UBillboardComponent&) = delete; \
