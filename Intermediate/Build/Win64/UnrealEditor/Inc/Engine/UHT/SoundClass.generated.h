...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_USoundClass_NoRegister(); \
public: \
	DECLARE_CLASS2(USoundClass, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_USoundClass_NoRegister) \
	DECLARE_SERIALIZER(USoundClass) \
	FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundClass_h_210_ARCHIVESERIALIZER \
	virtual UObject* _getUObject() const override { return const_cast<USoundClass*>(this); }
...
#define FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundClass_h_210_STANDARD_CONSTRUCTORS \
	...
	USoundClass(USoundClass&&) = delete; \
	USoundClass(const USoundClass&) = delete; \
