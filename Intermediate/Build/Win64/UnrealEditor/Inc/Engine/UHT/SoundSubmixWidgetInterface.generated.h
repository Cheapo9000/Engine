...
#define FID_Engine_Source_Runtime_Engine_Public_Audio_SoundSubmixWidgetInterface_h_16_ENHANCED_CONSTRUCTORS \
	...
	USoundSubmixWidgetInterface(USoundSubmixWidgetInterface&&) = delete; \
	USoundSubmixWidgetInterface(const USoundSubmixWidgetInterface&) = delete; \
	...
	virtual ~USoundSubmixWidgetInterface() = default;
...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_USoundSubmixWidgetInterface_NoRegister(); \
public: \
	DECLARE_CLASS2(USoundSubmixWidgetInterface, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_USoundSubmixWidgetInterface_NoRegister) \
...
class USoundSubmixWidgetInterface;
