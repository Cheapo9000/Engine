...
#define FID_Engine_Source_Runtime_Engine_Classes_Interfaces_Interface_PreviewMeshProvider_h_15_STANDARD_CONSTRUCTORS \
	...
	UInterface_PreviewMeshProvider(UInterface_PreviewMeshProvider&&) = delete; \
	UInterface_PreviewMeshProvider(const UInterface_PreviewMeshProvider&) = delete; \
	virtual ~UInterface_PreviewMeshProvider() = default;
...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UInterface_PreviewMeshProvider_NoRegister(); \
public: \
	DECLARE_CLASS2(UInterface_PreviewMeshProvider, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UInterface_PreviewMeshProvider_NoRegister) \
