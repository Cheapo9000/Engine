...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UTimecodeProvider_NoRegister(); \
public: \
	DECLARE_CLASS2(UTimecodeProvider, UObject, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UTimecodeProvider_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Engine_TimecodeProvider_h_42_ENHANCED_CONSTRUCTORS \
	...
	UTimecodeProvider(UTimecodeProvider&&) = delete; \
	UTimecodeProvider(const UTimecodeProvider&) = delete; \
...
template<> ENGINE_NON_ATTRIBUTED_API UEnum* StaticEnum<ETimecodeProviderSynchronizationState>();
