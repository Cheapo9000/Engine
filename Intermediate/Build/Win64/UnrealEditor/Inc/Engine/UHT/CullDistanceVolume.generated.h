...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_ACullDistanceVolume_NoRegister(); \
public: \
	DECLARE_CLASS2(ACullDistanceVolume, AVolume, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_ACullDistanceVolume_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Engine_CullDistanceVolume_h_45_STANDARD_CONSTRUCTORS \
	...
	ACullDistanceVolume(ACullDistanceVolume&&) = delete; \
	ACullDistanceVolume(const ACullDistanceVolume&) = delete; \
