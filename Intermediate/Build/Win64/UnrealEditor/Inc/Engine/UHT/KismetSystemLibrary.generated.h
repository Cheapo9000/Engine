...
class UScriptStruct;
class UTexture2D;
enum class EDrawDebugSceneDepthPriorityGroup : uint8;
...
#define FID_Engine_Source_Runtime_Engine_Classes_Kismet_KismetSystemLibrary_h_101_GENERATED_BODY \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Kismet_KismetSystemLibrary_h_452_DELEGATE \
static ENGINE_API void FOnAssetLoaded_DelegateWrapper(const FScriptDelegate& OnAssetLoaded, UObject* Loaded);


// ********** End Delegate FOnAssetLoaded **********************************************************

// ********** Begin Delegate FOnAssetClassLoaded ***************************************************
#define FID_Engine_Source_Runtime_Engine_Classes_Kismet_KismetSystemLibrary_h_457_DELEGATE \
static ENGINE_API void FOnAssetClassLoaded_DelegateWrapper(const FScriptDelegate& OnAssetClassLoaded, TSubclassOf<UObject> Loaded);


// ********** End Delegate FOnAssetClassLoaded *****************************************************

// ********** Begin Delegate FOnAssetsLoaded *******************************************************
#define FID_Engine_Source_Runtime_Engine_Classes_Kismet_KismetSystemLibrary_h_462_DELEGATE \
static ENGINE_API void FOnAssetsLoaded_DelegateWrapper(const FScriptDelegate& OnAssetsLoaded, TArray<UObject*> const& Loaded);


// ********** End Delegate FOnAssetsLoaded *********************************************************

// ********** Begin Class UKismetSystemLibrary *****************************************************
#define FID_Engine_Source_Runtime_Engine_Classes_Kismet_KismetSystemLibrary_h_110_RPC_WRAPPERS \
	...
	DECLARE_FUNCTION(execLaunchExternalUrl); \
	...
	DECLARE_FUNCTION(execCapsuleOverlapComponentsWithOrientation); \
	DECLARE_FUNCTION(execCapsuleOverlapComponents); \
	DECLARE_FUNCTION(execCapsuleOverlapActorsWithOrientation); \
	DECLARE_FUNCTION(execCapsuleOverlapActors); \
	DECLARE_FUNCTION(execBoxOverlapComponentsWithOrientation); \
	DECLARE_FUNCTION(execBoxOverlapComponents); \
	DECLARE_FUNCTION(execBoxOverlapActorsWithOrientation); \
	...
	DECLARE_FUNCTION(execDelayUntilNextFrame); \
	...
	DECLARE_FUNCTION(execConv_ComponentReferenceToSoftComponentReference); \
	...
	DECLARE_FUNCTION(execIsObjectOfSoftClass); \
	...
	DECLARE_FUNCTION(execGetSoftClassTopLevelAssetPath); \
	...
	DECLARE_FUNCTION(execIsValidInterface); \
	...
	DECLARE_FUNCTION(execDoesClassImplementInterface); \
	...
	DECLARE_FUNCTION(execGetEnumTopLevelAssetPath); \
	DECLARE_FUNCTION(execGetStructTopLevelAssetPath); \
	DECLARE_FUNCTION(execGetClassTopLevelAssetPath); \
	...
	DECLARE_FUNCTION(execRaiseScriptError);


#if WITH_EDITOR
#define FID_Engine_Source_Runtime_Engine_Classes_Kismet_KismetSystemLibrary_h_110_RPC_WRAPPERS_EOD \
	DECLARE_FUNCTION(execIsEditorPropertyOverridden); \
	DECLARE_FUNCTION(execResetEditorProperty); \
	DECLARE_FUNCTION(execGetCollisionProfileNames); \
	DECLARE_FUNCTION(execQuitEditor); \
	DECLARE_FUNCTION(execGetPlatformTime_Seconds); \
	DECLARE_FUNCTION(execDuplicateObject); \
	DECLARE_FUNCTION(execObjectHasEditorOnlyData); \
	DECLARE_FUNCTION(execIsObjectCooked);
#else // WITH_EDITOR
#define FID_Engine_Source_Runtime_Engine_Classes_Kismet_KismetSystemLibrary_h_110_RPC_WRAPPERS_EOD
#endif // WITH_EDITOR
...
#define FID_Engine_Source_Runtime_Engine_Classes_Kismet_KismetSystemLibrary_h_110_INCLASS \
private: \
	static void StaticRegisterNativesUKismetSystemLibrary(); \
	friend struct ::Z_Construct_UClass_UKismetSystemLibrary_Statics; \
	friend struct ::Z_Construct_UFunction_UKismetSystemLibrary_StackTrace_Statics; \
	friend struct ::Z_Construct_UFunction_UKismetSystemLibrary_SetCollisionProfileNameProperty_Statics; \
	friend struct ::Z_Construct_UFunction_UKismetSystemLibrary_SetStructurePropertyByName_Statics; \
	friend struct ::Z_Construct_UFunction_UKismetSystemLibrary_GetEditorProperty_Statics; \
	friend struct ::Z_Construct_UFunction_UKismetSystemLibrary_SetEditorProperty_Statics; \
	static UClass* GetPrivateStaticClass(); \
	friend ENGINE_API UClass* ::Z_Construct_UClass_UKismetSystemLibrary_NoRegister(); \
public: \
	DECLARE_CLASS2(UKismetSystemLibrary, UBlueprintFunctionLibrary, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UKismetSystemLibrary_NoRegister) \
	DECLARE_SERIALIZER(UKismetSystemLibrary)


#define FID_Engine_Source_Runtime_Engine_Classes_Kismet_KismetSystemLibrary_h_110_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(ENGINE_API, UKismetSystemLibrary); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UKismetSystemLibrary); \
	/** Deleted move- and copy-constructors, should never be used */ \
	UKismetSystemLibrary(UKismetSystemLibrary&&) = delete; \
	UKismetSystemLibrary(const UKismetSystemLibrary&) = delete; \
	ENGINE_API virtual ~UKismetSystemLibrary();


#define FID_Engine_Source_Runtime_Engine_Classes_Kismet_KismetSystemLibrary_h_107_PROLOG
#define FID_Engine_Source_Runtime_Engine_Classes_Kismet_KismetSystemLibrary_h_110_GENERATED_BODY_LEGACY \
PRAGMA_DISABLE_DEPRECATION_WARNINGS \
public: \
	FID_Engine_Source_Runtime_Engine_Classes_Kismet_KismetSystemLibrary_h_110_RPC_WRAPPERS \
	FID_Engine_Source_Runtime_Engine_Classes_Kismet_KismetSystemLibrary_h_110_RPC_WRAPPERS_EOD \
	FID_Engine_Source_Runtime_Engine_Classes_Kismet_KismetSystemLibrary_h_110_INCLASS \
	FID_Engine_Source_Runtime_Engine_Classes_Kismet_KismetSystemLibrary_h_110_STANDARD_CONSTRUCTORS \
public: \
...
#define FOREACH_ENUM_EDRAWDEBUGSCENEDEPTHPRIORITYGROUP(op) \
	op(EDrawDebugSceneDepthPriorityGroup::World) \
	op(EDrawDebugSceneDepthPriorityGroup::Foreground) 

enum class EDrawDebugSceneDepthPriorityGroup : uint8;
template<> struct TIsUEnumClass<EDrawDebugSceneDepthPriorityGroup> { enum { Value = true }; };
...
#define FOREACH_ENUM_EEDITORPROPERTYVALUESTATE(op) \
	op(EEditorPropertyValueState::Default) \
	op(EEditorPropertyValueState::Overridden) \
	op(EEditorPropertyValueState::NotFound) \
	op(EEditorPropertyValueState::AccessDenied) 

enum class EEditorPropertyValueState : uint8;
template<> struct TIsUEnumClass<EEditorPropertyValueState> { enum { Value = true }; };
