...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UNavMovementComponent_NoRegister(); \
public: \
	DECLARE_CLASS2(UNavMovementComponent, UMovementComponent, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UNavMovementComponent_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_GameFramework_NavMovementComponent_h_28_STANDARD_CONSTRUCTORS \
	...
	UNavMovementComponent(UNavMovementComponent&&) = delete; \
	UNavMovementComponent(const UNavMovementComponent&) = delete; \
