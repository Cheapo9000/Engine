...
#define FID_Engine_Source_Runtime_Engine_Public_LODSyncInterface_h_14_STANDARD_CONSTRUCTORS \
	...
	ULODSyncInterface(ULODSyncInterface&&) = delete; \
	ULODSyncInterface(const ULODSyncInterface&) = delete; \
	virtual ~ULODSyncInterface() = default;
...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_ULODSyncInterface_NoRegister(); \
public: \
	DECLARE_CLASS2(ULODSyncInterface, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_ULODSyncInterface_NoRegister) \
