...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UEngineCustomTimeStep_NoRegister(); \
public: \
	DECLARE_CLASS2(UEngineCustomTimeStep, UObject, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UEngineCustomTimeStep_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Engine_EngineCustomTimeStep_h_37_ENHANCED_CONSTRUCTORS \
	...
	UEngineCustomTimeStep(UEngineCustomTimeStep&&) = delete; \
	UEngineCustomTimeStep(const UEngineCustomTimeStep&) = delete; \
...
template<> ENGINE_NON_ATTRIBUTED_API UEnum* StaticEnum<ECustomTimeStepSynchronizationState>();
