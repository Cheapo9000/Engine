...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UParticleModuleCollisionBase_NoRegister(); \
public: \
	DECLARE_CLASS2(UParticleModuleCollisionBase, UParticleModule, COMPILED_IN_FLAGS(CLASS_Abstract), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UParticleModuleCollisionBase_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Particles_Collision_ParticleModuleCollisionBase_h_35_STANDARD_CONSTRUCTORS \
	...
	UParticleModuleCollisionBase(UParticleModuleCollisionBase&&) = delete; \
	UParticleModuleCollisionBase(const UParticleModuleCollisionBase&) = delete; \
...
template<> ENGINE_NON_ATTRIBUTED_API UEnum* StaticEnum<EParticleCollisionComplete>();
