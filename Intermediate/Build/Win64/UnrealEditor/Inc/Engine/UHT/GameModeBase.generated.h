...
public: \
	DECLARE_CLASS2(AGameModeBase, AInfo, COMPILED_IN_FLAGS(0 | CLASS_Transient | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_AGameModeBase_NoRegister) \
