...
#define FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimData_IAnimationDataController_h_46_RPC_WRAPPERS_NO_PURE_DECLS \
	...
	DECLARE_FUNCTION(execSetCurveComment); \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimData_IAnimationDataController_h_46_ENHANCED_CONSTRUCTORS \
	...
	ENGINE_API UAnimationDataController(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
	/** Deleted move- and copy-constructors, should never be used */ \
	UAnimationDataController(UAnimationDataController&&) = delete; \
	UAnimationDataController(const UAnimationDataController&) = delete; \
	DECLARE_VTABLE_PTR_HELPER_CTOR(ENGINE_API, UAnimationDataController); \
	...
	virtual ~UAnimationDataController() = default;
...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UAnimationDataController_NoRegister(); \
public: \
	DECLARE_CLASS2(UAnimationDataController, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UAnimationDataController_NoRegister) \
