...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_AParticleEventManager_NoRegister(); \
public: \
	DECLARE_CLASS2(AParticleEventManager, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_AParticleEventManager_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Particles_ParticleEventManager_h_16_STANDARD_CONSTRUCTORS \
	...
	AParticleEventManager(AParticleEventManager&&) = delete; \
	AParticleEventManager(const AParticleEventManager&) = delete; \
