...
#define FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeDialoguePlayer_h_23_INCLASS \
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_USoundNodeDialoguePlayer_NoRegister(); \
public: \
	DECLARE_CLASS2(USoundNodeDialoguePlayer, USoundNode, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_USoundNodeDialoguePlayer_NoRegister) \
	DECLARE_SERIALIZER(USoundNodeDialoguePlayer)


#define FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeDialoguePlayer_h_23_STANDARD_CONSTRUCTORS \
	...
	USoundNodeDialoguePlayer(USoundNodeDialoguePlayer&&) = delete; \
	USoundNodeDialoguePlayer(const USoundNodeDialoguePlayer&) = delete; \
	ENGINE_API virtual ~USoundNodeDialoguePlayer();


#define FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeDialoguePlayer_h_20_PROLOG
#define FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeDialoguePlayer_h_23_GENERATED_BODY_LEGACY \
PRAGMA_DISABLE_DEPRECATION_WARNINGS \
public: \
	FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeDialoguePlayer_h_23_INCLASS \
	FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeDialoguePlayer_h_23_STANDARD_CONSTRUCTORS \
public: \
