...
private: \
	...
	friend ANIMGRAPHRUNTIME_API UClass* ::Z_Construct_UClass_UBlendSpacePlayerLibrary_NoRegister(); \
public: \
	DECLARE_CLASS2(UBlendSpacePlayerLibrary, UBlueprintFunctionLibrary, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/AnimGraphRuntime"), Z_Construct_UClass_UBlendSpacePlayerLibrary_NoRegister) \
...
#define FID_Engine_Source_Runtime_AnimGraphRuntime_Public_BlendSpacePlayerLibrary_h_27_ENHANCED_CONSTRUCTORS \
	...
	ANIMGRAPHRUNTIME_API UBlendSpacePlayerLibrary(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
	/** Deleted move- and copy-constructors, should never be used */ \
	UBlendSpacePlayerLibrary(UBlendSpacePlayerLibrary&&) = delete; \
	UBlendSpacePlayerLibrary(const UBlendSpacePlayerLibrary&) = delete; \
	DECLARE_VTABLE_PTR_HELPER_CTOR(ANIMGRAPHRUNTIME_API, UBlendSpacePlayerLibrary); \
	...
	ANIMGRAPHRUNTIME_API virtual ~UBlendSpacePlayerLibrary();
