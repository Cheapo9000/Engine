...
// ********** Begin Class UAnimGraphNode_IdentityPose **********************************************
...
private: \
	...
	friend ANIMGRAPH_API UClass* ::Z_Construct_UClass_UAnimGraphNode_IdentityPose_NoRegister(); \
public: \
	DECLARE_CLASS2(UAnimGraphNode_IdentityPose, UAnimGraphNode_RefPoseBase, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/AnimGraph"), Z_Construct_UClass_UAnimGraphNode_IdentityPose_NoRegister) \
...
#define FID_Engine_Source_Editor_AnimGraph_Public_AnimGraphNode_IdentityPose_h_13_STANDARD_CONSTRUCTORS \
	...
	UAnimGraphNode_IdentityPose(UAnimGraphNode_IdentityPose&&) = delete; \
	UAnimGraphNode_IdentityPose(const UAnimGraphNode_IdentityPose&) = delete; \
...
class UAnimGraphNode_IdentityPose;

// ********** End Class UAnimGraphNode_IdentityPose ************************************************
