...
// ********** Begin Class UAnimGraphNode_RigidBody *************************************************
...
private: \
	...
	friend ANIMGRAPH_API UClass* ::Z_Construct_UClass_UAnimGraphNode_RigidBody_NoRegister(); \
public: \
	DECLARE_CLASS2(UAnimGraphNode_RigidBody, UAnimGraphNode_SkeletalControlBase, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/AnimGraph"), Z_Construct_UClass_UAnimGraphNode_RigidBody_NoRegister) \
...
#define FID_Engine_Source_Editor_AnimGraph_Public_AnimGraphNode_RigidBody_h_13_STANDARD_CONSTRUCTORS \
	...
	UAnimGraphNode_RigidBody(UAnimGraphNode_RigidBody&&) = delete; \
	UAnimGraphNode_RigidBody(const UAnimGraphNode_RigidBody&) = delete; \
...
class UAnimGraphNode_RigidBody;

// ********** End Class UAnimGraphNode_RigidBody ***************************************************
