...
template<> PHYSICSCORE_NON_ATTRIBUTED_API UEnum* StaticEnum<EPhysicalSurface>();
// ********** End Enum EPhysicalSurface ************************************************************

// ********** Begin Enum ERadialImpulseFalloff *****************************************************
#define FOREACH_ENUM_ERADIALIMPULSEFALLOFF(op) \
	op(RIF_Constant) \
	op(RIF_Linear) 

enum ERadialImpulseFalloff : int;
template<> PHYSICSCORE_NON_ATTRIBUTED_API UEnum* StaticEnum<ERadialImpulseFalloff>();
// ********** End Enum ERadialImpulseFalloff *******************************************************

// ********** Begin Enum ESleepFamily **************************************************************
...
template<> PHYSICSCORE_NON_ATTRIBUTED_API UEnum* StaticEnum<ESleepFamily>();
// ********** End Enum ESleepFamily ****************************************************************

// ********** Begin Enum EAngularConstraintMotion **************************************************
...
template<> PHYSICSCORE_NON_ATTRIBUTED_API UEnum* StaticEnum<EAngularConstraintMotion>();
// ********** End Enum EAngularConstraintMotion ****************************************************

// ********** Begin Enum EConstraintFrame **********************************************************
...
template<> PHYSICSCORE_NON_ATTRIBUTED_API UEnum* StaticEnum<EConstraintFrame::Type>();
// ********** End Enum EConstraintFrame ************************************************************

// ********** Begin Enum EConstraintPlasticityType *************************************************
...
template<> PHYSICSCORE_NON_ATTRIBUTED_API UEnum* StaticEnum<EConstraintPlasticityType>();
// ********** End Enum EConstraintPlasticityType ***************************************************

// ********** Begin Enum ELinearConstraintMotion ***************************************************
...
template<> PHYSICSCORE_NON_ATTRIBUTED_API UEnum* StaticEnum<ELinearConstraintMotion>();
// ********** End Enum ELinearConstraintMotion *****************************************************
