...
// ********** Begin Class UAnimationRecordingParameters ********************************************
...
private: \
	...
	friend SEQUENCERECORDER_API UClass* ::Z_Construct_UClass_UAnimationRecordingParameters_NoRegister(); \
public: \
	DECLARE_CLASS2(UAnimationRecordingParameters, UObject, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/SequenceRecorder"), Z_Construct_UClass_UAnimationRecordingParameters_NoRegister) \
...
#define FID_Engine_Source_Editor_SequenceRecorder_Private_AnimationRecorderParameters_h_17_ENHANCED_CONSTRUCTORS \
	...
	UAnimationRecordingParameters(UAnimationRecordingParameters&&) = delete; \
	UAnimationRecordingParameters(const UAnimationRecordingParameters&) = delete; \
...
class UAnimationRecordingParameters;

// ********** End Class UAnimationRecordingParameters **********************************************
