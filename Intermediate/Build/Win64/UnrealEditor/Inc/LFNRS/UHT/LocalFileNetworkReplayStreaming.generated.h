...
#define FOREACH_ENUM_ELOCALFILEREPLAYRESULT(op) \
	...
	op(ELocalFileReplayResult::EncryptBuffer) \
	op(ELocalFileReplayResult::CompressBuffer) \
	op(ELocalFileReplayResult::InvalidName) \
	op(ELocalFileReplayResult::FileWriter) \
...
template<> LOCALFILENETWORKREPLAYSTREAMING_NON_ATTRIBUTED_API UEnum* StaticEnum<ELocalFileReplayResult>();
