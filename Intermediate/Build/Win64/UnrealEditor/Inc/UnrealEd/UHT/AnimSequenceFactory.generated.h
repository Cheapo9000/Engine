...
// ********** Begin Class UAnimSequenceFactory *****************************************************
...
private: \
	...
	friend UNREALED_API UClass* ::Z_Construct_UClass_UAnimSequenceFactory_NoRegister(); \
public: \
	DECLARE_CLASS2(UAnimSequenceFactory, UFactory, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/UnrealEd"), Z_Construct_UClass_UAnimSequenceFactory_NoRegister) \
...
#define FID_Engine_Source_Editor_UnrealEd_Classes_Factories_AnimSequenceFactory_h_20_STANDARD_CONSTRUCTORS \
	...
	UAnimSequenceFactory(UAnimSequenceFactory&&) = delete; \
	UAnimSequenceFactory(const UAnimSequenceFactory&) = delete; \
...
// ********** End Class UAnimSequenceFactory *******************************************************
