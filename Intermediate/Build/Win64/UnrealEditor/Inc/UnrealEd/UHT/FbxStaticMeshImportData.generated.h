...
// ********** Begin Class UFbxStaticMeshImportData *************************************************
...
private: \
	...
	friend UNREALED_API UClass* ::Z_Construct_UClass_UFbxStaticMeshImportData_NoRegister(); \
public: \
	DECLARE_CLASS2(UFbxStaticMeshImportData, UFbxMeshImportData, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/UnrealEd"), Z_Construct_UClass_UFbxStaticMeshImportData_NoRegister) \
...
#define FID_Engine_Source_Editor_UnrealEd_Classes_Factories_FbxStaticMeshImportData_h_19_STANDARD_CONSTRUCTORS \
	...
	UFbxStaticMeshImportData(UFbxStaticMeshImportData&&) = delete; \
	UFbxStaticMeshImportData(const UFbxStaticMeshImportData&) = delete; \
...
// ********** End Class UFbxStaticMeshImportData ***************************************************
