...
// ********** Begin Class USpecularProfileFactory **************************************************
struct Z_Construct_UClass_USpecularProfileFactory_Statics;
UNREALED_API UClass* Z_Construct_UClass_USpecularProfileFactory_NoRegister();
...
private: \
	...
	friend UNREALED_API UClass* ::Z_Construct_UClass_USpecularProfileFactory_NoRegister(); \
public: \
	DECLARE_CLASS2(USpecularProfileFactory, UFactory, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/UnrealEd"), Z_Construct_UClass_USpecularProfileFactory_NoRegister) \
...
#define FID_Engine_Source_Editor_UnrealEd_Classes_Factories_SpecularProfileFactory_h_13_STANDARD_CONSTRUCTORS \
	...
	USpecularProfileFactory(USpecularProfileFactory&&) = delete; \
	USpecularProfileFactory(const USpecularProfileFactory&) = delete; \
...
class USpecularProfileFactory;

// ********** End Class USpecularProfileFactory ****************************************************
