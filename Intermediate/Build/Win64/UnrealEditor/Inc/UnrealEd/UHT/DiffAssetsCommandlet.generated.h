...
// ********** Begin Class UDiffAssetsCommandlet ****************************************************
...
private: \
	...
	friend UNREALED_API UClass* ::Z_Construct_UClass_UDiffAssetsCommandlet_NoRegister(); \
public: \
	DECLARE_CLASS2(UDiffAssetsCommandlet, UCommandlet, COMPILED_IN_FLAGS(0 | CLASS_Transient), CASTCLASS_None, TEXT("/Script/UnrealEd"), Z_Construct_UClass_UDiffAssetsCommandlet_NoRegister) \
...
#define FID_Engine_Source_Editor_UnrealEd_Classes_Commandlets_DiffAssetsCommandlet_h_17_STANDARD_CONSTRUCTORS \
	...
	UDiffAssetsCommandlet(UDiffAssetsCommandlet&&) = delete; \
	UDiffAssetsCommandlet(const UDiffAssetsCommandlet&) = delete; \
...
class UDiffAssetsCommandlet;

// ********** End Class UDiffAssetsCommandlet ******************************************************
