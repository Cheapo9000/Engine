...
#define FID_Engine_Source_Editor_AnimationBlueprintLibrary_Public_AnimationBlueprintLibrary_h_62_DELEGATE \
...
#define FID_Engine_Source_Editor_AnimationBlueprintLibrary_Public_AnimationBlueprintLibrary_h_68_RPC_WRAPPERS_NO_PURE_DECLS \
	...
	DECLARE_FUNCTION(execEvaluateBoneTimecodeAndSlateAttributesAtTime); \
	...
	DECLARE_FUNCTION(execRemoveBoneSelectiveAnimation); \
	DECLARE_FUNCTION(execRemoveBoneAnimation); \
	DECLARE_FUNCTION(execCopyAnimationCurveNamesToSkeleton); \
	DECLARE_FUNCTION(execGetFloatValueAtTime); \
	DECLARE_FUNCTION(execGetTransformationKeys); \
	DECLARE_FUNCTION(execGetVectorKeys); \
	DECLARE_FUNCTION(execGetFloatKeys); \
	DECLARE_FUNCTION(execSetCurveMetaDataMorphTarget); \
	DECLARE_FUNCTION(execSetCurveMetaDataMaterial); \
	DECLARE_FUNCTION(execGetCurveMetaDataMorphTarget); \
	DECLARE_FUNCTION(execGetCurveMetaDataMaterial); \
	DECLARE_FUNCTION(execRemoveCurveMetaData); \
	DECLARE_FUNCTION(execRenameCurveMetaData); \
	DECLARE_FUNCTION(execGetCurveMetaDataNames); \
	DECLARE_FUNCTION(execAddCurveMetaData); \
	DECLARE_FUNCTION(execGetNumCurveMetaData); \
	...
	DECLARE_FUNCTION(execAddAnimationNotifyEventFromSource); \
	...
	DECLARE_FUNCTION(execSetVariableFrameStrippingSettings); \
	DECLARE_FUNCTION(execGetVariableFrameStrippingSettings); \
	...
	DECLARE_FUNCTION(execExtractRootTrackTransform); \
...
#define FID_Engine_Source_Editor_AnimationBlueprintLibrary_Public_AnimationBlueprintLibrary_h_68_INCLASS_NO_PURE_DECLS \
private: \
	...
	friend ANIMATIONBLUEPRINTLIBRARY_API UClass* ::Z_Construct_UClass_UAnimationBlueprintLibrary_NoRegister(); \
public: \
	DECLARE_CLASS2(UAnimationBlueprintLibrary, UBlueprintFunctionLibrary, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/AnimationBlueprintLibrary"), Z_Construct_UClass_UAnimationBlueprintLibrary_NoRegister) \
	DECLARE_SERIALIZER(UAnimationBlueprintLibrary)


#define FID_Engine_Source_Editor_AnimationBlueprintLibrary_Public_AnimationBlueprintLibrary_h_68_ENHANCED_CONSTRUCTORS \
	/** Standard constructor, called after all reflected properties have been initialized */ \
	ANIMATIONBLUEPRINTLIBRARY_API UAnimationBlueprintLibrary(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
	/** Deleted move- and copy-constructors, should never be used */ \
	UAnimationBlueprintLibrary(UAnimationBlueprintLibrary&&) = delete; \
	UAnimationBlueprintLibrary(const UAnimationBlueprintLibrary&) = delete; \
	DECLARE_VTABLE_PTR_HELPER_CTOR(ANIMATIONBLUEPRINTLIBRARY_API, UAnimationBlueprintLibrary); \
	...
	ANIMATIONBLUEPRINTLIBRARY_API virtual ~UAnimationBlueprintLibrary();


#define FID_Engine_Source_Editor_AnimationBlueprintLibrary_Public_AnimationBlueprintLibrary_h_65_PROLOG
#define FID_Engine_Source_Editor_AnimationBlueprintLibrary_Public_AnimationBlueprintLibrary_h_68_GENERATED_BODY \
PRAGMA_DISABLE_DEPRECATION_WARNINGS \
public: \
	FID_Engine_Source_Editor_AnimationBlueprintLibrary_Public_AnimationBlueprintLibrary_h_68_RPC_WRAPPERS_NO_PURE_DECLS \
	FID_Engine_Source_Editor_AnimationBlueprintLibrary_Public_AnimationBlueprintLibrary_h_68_INCLASS_NO_PURE_DECLS \
	FID_Engine_Source_Editor_AnimationBlueprintLibrary_Public_AnimationBlueprintLibrary_h_68_ENHANCED_CONSTRUCTORS \
private: \
