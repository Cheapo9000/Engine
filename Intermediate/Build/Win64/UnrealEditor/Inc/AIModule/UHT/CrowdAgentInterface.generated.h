...
#define FID_Engine_Source_Runtime_AIModule_Classes_Navigation_CrowdAgentInterface_h_14_STANDARD_CONSTRUCTORS \
	...
	UCrowdAgentInterface(UCrowdAgentInterface&&) = delete; \
	UCrowdAgentInterface(const UCrowdAgentInterface&) = delete; \
	virtual ~UCrowdAgentInterface() = default;
...
public: \
	DECLARE_CLASS2(UCrowdAgentInterface, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/AIModule"), Z_Construct_UClass_UCrowdAgentInterface_NoRegister) \
