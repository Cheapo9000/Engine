...
#define FID_Engine_Source_Runtime_InteractiveToolsFramework_Public_InteractiveToolChange_h_31_ENHANCED_CONSTRUCTORS \
	...
	UToolContextTransactionProvider(UToolContextTransactionProvider&&) = delete; \
	UToolContextTransactionProvider(const UToolContextTransactionProvider&) = delete; \
	...
	virtual ~UToolContextTransactionProvider() = default;
...
private: \
	...
	friend INTERACTIVETOOLSFRAMEWORK_API UClass* ::Z_Construct_UClass_UToolContextTransactionProvider_NoRegister(); \
public: \
	DECLARE_CLASS2(UToolContextTransactionProvider, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/InteractiveToolsFramework"), Z_Construct_UClass_UToolContextTransactionProvider_NoRegister) \
