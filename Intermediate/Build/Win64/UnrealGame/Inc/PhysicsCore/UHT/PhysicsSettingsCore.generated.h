...
// ********** Begin Class UPhysicsSettingsCore *****************************************************
...
private: \
	...
	friend PHYSICSCORE_API UClass* ::Z_Construct_UClass_UPhysicsSettingsCore_NoRegister(); \
public: \
	DECLARE_CLASS2(UPhysicsSettingsCore, UDeveloperSettings, COMPILED_IN_FLAGS(0 | CLASS_DefaultConfig | CLASS_Config), CASTCLASS_None, TEXT("/Script/PhysicsCore"), Z_Construct_UClass_UPhysicsSettingsCore_NoRegister) \
...
#define FID_Engine_Source_Runtime_PhysicsCore_Public_PhysicsSettingsCore_h_21_STANDARD_CONSTRUCTORS \
	...
	UPhysicsSettingsCore(UPhysicsSettingsCore&&) = delete; \
	UPhysicsSettingsCore(const UPhysicsSettingsCore&) = delete; \
...
// ********** End Class UPhysicsSettingsCore *******************************************************
