...
private: \
	...
	friend PHYSICSCORE_API UClass* ::Z_Construct_UClass_UChaosPhysicalMaterial_NoRegister(); \
public: \
	DECLARE_CLASS2(UChaosPhysicalMaterial, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/PhysicsCore"), Z_Construct_UClass_UChaosPhysicalMaterial_NoRegister) \
...
#define FID_Engine_Source_Runtime_PhysicsCore_Public_Chaos_ChaosPhysicalMaterial_h_24_STANDARD_CONSTRUCTORS \
	...
	UChaosPhysicalMaterial(UChaosPhysicalMaterial&&) = delete; \
	UChaosPhysicalMaterial(const UChaosPhysicalMaterial&) = delete; \
