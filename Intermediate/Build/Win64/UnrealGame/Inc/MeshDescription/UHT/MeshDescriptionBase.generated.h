...
#define FID_Engine_Source_Runtime_MeshDescription_Public_MeshDescriptionBase_h_27_ARCHIVESERIALIZER \
	DECLARE_FSTRUCTUREDARCHIVE_SERIALIZER(UMeshDescriptionBase, MESHDESCRIPTION_API)
...
private: \
	...
	friend MESHDESCRIPTION_API UClass* ::Z_Construct_UClass_UMeshDescriptionBase_NoRegister(); \
public: \
	DECLARE_CLASS2(UMeshDescriptionBase, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/MeshDescription"), Z_Construct_UClass_UMeshDescriptionBase_NoRegister) \
...
#define FID_Engine_Source_Runtime_MeshDescription_Public_MeshDescriptionBase_h_27_ENHANCED_CONSTRUCTORS \
	...
	MESHDESCRIPTION_API UMeshDescriptionBase(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
	/** Deleted move- and copy-constructors, should never be used */ \
	UMeshDescriptionBase(UMeshDescriptionBase&&) = delete; \
	UMeshDescriptionBase(const UMeshDescriptionBase&) = delete; \
	DECLARE_VTABLE_PTR_HELPER_CTOR(MESHDESCRIPTION_API, UMeshDescriptionBase); \
	...
	MESHDESCRIPTION_API virtual ~UMeshDescriptionBase();
