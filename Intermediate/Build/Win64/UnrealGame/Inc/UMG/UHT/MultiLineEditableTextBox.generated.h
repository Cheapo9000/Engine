...
static UMG_API void FOnMultiLineEditableTextBoxChangedEvent_DelegateWrapper(const FMulticastScriptDelegate& OnMultiLineEditableTextBoxChangedEvent, FText const& Text);
...
static UMG_API void FOnMultiLineEditableTextBoxCommittedEvent_DelegateWrapper(const FMulticastScriptDelegate& OnMultiLineEditableTextBoxCommittedEvent, FText const& Text, ETextCommit::Type CommitMethod);
...
#define FID_Engine_Source_Runtime_UMG_Public_Components_MultiLineEditableTextBox_h_23_ARCHIVESERIALIZER \
	DECLARE_FSTRUCTUREDARCHIVE_SERIALIZER(UMultiLineEditableTextBox, UMG_API)
...
private: \
	...
	friend UMG_API UClass* ::Z_Construct_UClass_UMultiLineEditableTextBox_NoRegister(); \
public: \
	DECLARE_CLASS2(UMultiLineEditableTextBox, UTextLayoutWidget, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/UMG"), Z_Construct_UClass_UMultiLineEditableTextBox_NoRegister) \
...
#define FID_Engine_Source_Runtime_UMG_Public_Components_MultiLineEditableTextBox_h_23_STANDARD_CONSTRUCTORS \
	...
	UMG_API UMultiLineEditableTextBox(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
	DEFINE_DEFAULT_OBJECT_INITIALIZER_CONSTRUCTOR_CALL(UMultiLineEditableTextBox) \
	DECLARE_VTABLE_PTR_HELPER_CTOR(UMG_API, UMultiLineEditableTextBox); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UMultiLineEditableTextBox); \
	/** Deleted move- and copy-constructors, should never be used */ \
	UMultiLineEditableTextBox(UMultiLineEditableTextBox&&) = delete; \
	UMultiLineEditableTextBox(const UMultiLineEditableTextBox&) = delete; \
	UMG_API virtual ~UMultiLineEditableTextBox();
