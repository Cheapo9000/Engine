...
private: \
	...
	friend AIMODULE_API UClass* ::Z_Construct_UClass_UEnvQueryTest_Distance_NoRegister(); \
public: \
	DECLARE_CLASS2(UEnvQueryTest_Distance, UEnvQueryTest, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/AIModule"), Z_Construct_UClass_UEnvQueryTest_Distance_NoRegister) \
...
#define FID_Engine_Source_Runtime_AIModule_Classes_EnvironmentQuery_Tests_EnvQueryTest_Distance_h_27_STANDARD_CONSTRUCTORS \
	...
	UEnvQueryTest_Distance(UEnvQueryTest_Distance&&) = delete; \
	UEnvQueryTest_Distance(const UEnvQueryTest_Distance&) = delete; \
...
template<> AIMODULE_NON_ATTRIBUTED_API UEnum* StaticEnum<EEnvTestDistance::Type>();
