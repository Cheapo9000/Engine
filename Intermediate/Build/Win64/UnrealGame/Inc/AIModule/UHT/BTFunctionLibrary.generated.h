...
private: \
	...
	friend AIMODULE_API UClass* ::Z_Construct_UClass_UBTFunctionLibrary_NoRegister(); \
public: \
	DECLARE_CLASS2(UBTFunctionLibrary, UBlueprintFunctionLibrary, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/AIModule"), Z_Construct_UClass_UBTFunctionLibrary_NoRegister) \
...
#define FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_BTFunctionLibrary_h_31_ENHANCED_CONSTRUCTORS \
	...
	AIMODULE_API UBTFunctionLibrary(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
	/** Deleted move- and copy-constructors, should never be used */ \
	UBTFunctionLibrary(UBTFunctionLibrary&&) = delete; \
	UBTFunctionLibrary(const UBTFunctionLibrary&) = delete; \
	DECLARE_VTABLE_PTR_HELPER_CTOR(AIMODULE_API, UBTFunctionLibrary); \
	...
	AIMODULE_API virtual ~UBTFunctionLibrary();
