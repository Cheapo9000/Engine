...
#define FOREACH_ENUM_ENETCLOSERESULT(op) \
	...
	op(ENetCloseResult::ReceivedNetExtBunchFail) \
	...
	op(ENetCloseResult::ReplicationChannelCountMaxedOut) \
	...
	op(ENetCloseResult::IrisProtocolMismatch) \
	op(ENetCloseResult::IrisNetRefHandleError) \
...
template<> NETCORE_NON_ATTRIBUTED_API UEnum* StaticEnum<ENetCloseResult>();
// ********** End Enum ENetCloseResult *************************************************************
