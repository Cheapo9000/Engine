...
private: \
	...
	friend INTERACTIVETOOLSFRAMEWORK_API UClass* ::Z_Construct_UClass_UMouseWheelInputBehavior_NoRegister(); \
public: \
	DECLARE_CLASS2(UMouseWheelInputBehavior, UAnyButtonInputBehavior, COMPILED_IN_FLAGS(0 | CLASS_Transient), CASTCLASS_None, TEXT("/Script/InteractiveToolsFramework"), Z_Construct_UClass_UMouseWheelInputBehavior_NoRegister) \
...
#define FID_Engine_Source_Runtime_InteractiveToolsFramework_Public_BaseBehaviors_MouseWheelBehavior_h_22_ENHANCED_CONSTRUCTORS \
	...
	UMouseWheelInputBehavior(UMouseWheelInputBehavior&&) = delete; \
	UMouseWheelInputBehavior(const UMouseWheelInputBehavior&) = delete; \
