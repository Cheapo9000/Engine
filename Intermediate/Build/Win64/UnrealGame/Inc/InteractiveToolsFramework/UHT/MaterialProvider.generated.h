...
#define FID_Engine_Source_Runtime_InteractiveToolsFramework_Public_TargetInterfaces_MaterialProvider_h_28_ENHANCED_CONSTRUCTORS \
	...
	UMaterialProvider(UMaterialProvider&&) = delete; \
	UMaterialProvider(const UMaterialProvider&) = delete; \
	...
	virtual ~UMaterialProvider() = default;
...
private: \
	...
	friend INTERACTIVETOOLSFRAMEWORK_API UClass* ::Z_Construct_UClass_UMaterialProvider_NoRegister(); \
public: \
	DECLARE_CLASS2(UMaterialProvider, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/InteractiveToolsFramework"), Z_Construct_UClass_UMaterialProvider_NoRegister) \
