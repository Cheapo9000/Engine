...
private: \
	...
	friend MOVIESCENETRACKS_API UClass* ::Z_Construct_UClass_UMovieSceneLevelVisibilitySystem_NoRegister(); \
public: \
	DECLARE_CLASS2(UMovieSceneLevelVisibilitySystem, UMovieSceneEntitySystem, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/MovieSceneTracks"), Z_Construct_UClass_UMovieSceneLevelVisibilitySystem_NoRegister) \
...
#define FID_Engine_Source_Runtime_MovieSceneTracks_Private_Systems_MovieSceneLevelVisibilitySystem_h_81_ENHANCED_CONSTRUCTORS \
	...
	UMovieSceneLevelVisibilitySystem(UMovieSceneLevelVisibilitySystem&&) = delete; \
	UMovieSceneLevelVisibilitySystem(const UMovieSceneLevelVisibilitySystem&) = delete; \
