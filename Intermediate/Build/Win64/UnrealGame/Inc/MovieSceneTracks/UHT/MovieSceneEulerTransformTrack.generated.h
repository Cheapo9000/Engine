...
private: \
	...
	friend MOVIESCENETRACKS_API UClass* ::Z_Construct_UClass_UMovieSceneEulerTransformTrack_NoRegister(); \
public: \
	DECLARE_CLASS2(UMovieSceneEulerTransformTrack, UMovieScenePropertyTrack, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/MovieSceneTracks"), Z_Construct_UClass_UMovieSceneEulerTransformTrack_NoRegister) \
...
#define FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneEulerTransformTrack_h_17_STANDARD_CONSTRUCTORS \
	...
	UMovieSceneEulerTransformTrack(UMovieSceneEulerTransformTrack&&) = delete; \
	UMovieSceneEulerTransformTrack(const UMovieSceneEulerTransformTrack&) = delete; \
