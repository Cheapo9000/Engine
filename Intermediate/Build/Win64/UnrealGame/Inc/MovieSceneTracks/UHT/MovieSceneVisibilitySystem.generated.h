...
private: \
	...
	friend MOVIESCENETRACKS_API UClass* ::Z_Construct_UClass_UMovieSceneVisibilitySystem_NoRegister(); \
public: \
	DECLARE_CLASS2(UMovieSceneVisibilitySystem, UMovieSceneEntityInstantiatorSystem, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/MovieSceneTracks"), Z_Construct_UClass_UMovieSceneVisibilitySystem_NoRegister) \
...
#define FID_Engine_Source_Runtime_MovieSceneTracks_Public_Systems_MovieSceneVisibilitySystem_h_25_ENHANCED_CONSTRUCTORS \
	...
	UMovieSceneVisibilitySystem(UMovieSceneVisibilitySystem&&) = delete; \
	UMovieSceneVisibilitySystem(const UMovieSceneVisibilitySystem&) = delete; \
...
class UMovieSceneVisibilitySystem;
