...
private: \
	...
	friend MOVIESCENETRACKS_API UClass* ::Z_Construct_UClass_UMovieSceneComponentMaterialSystem_NoRegister(); \
public: \
	DECLARE_CLASS2(UMovieSceneComponentMaterialSystem, UMovieSceneEntitySystem, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/MovieSceneTracks"), Z_Construct_UClass_UMovieSceneComponentMaterialSystem_NoRegister) \
...
#define FID_Engine_Source_Runtime_MovieSceneTracks_Public_Systems_MovieSceneComponentMaterialSystem_h_77_ENHANCED_CONSTRUCTORS \
	...
	UMovieSceneComponentMaterialSystem(UMovieSceneComponentMaterialSystem&&) = delete; \
	UMovieSceneComponentMaterialSystem(const UMovieSceneComponentMaterialSystem&) = delete; \
