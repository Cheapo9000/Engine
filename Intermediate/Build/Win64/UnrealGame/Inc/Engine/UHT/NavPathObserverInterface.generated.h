...
#define FID_Engine_Source_Runtime_Engine_Classes_AI_Navigation_NavPathObserverInterface_h_15_STANDARD_CONSTRUCTORS \
	...
	UNavPathObserverInterface(UNavPathObserverInterface&&) = delete; \
	UNavPathObserverInterface(const UNavPathObserverInterface&) = delete; \
	virtual ~UNavPathObserverInterface() = default;
...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UNavPathObserverInterface_NoRegister(); \
public: \
	DECLARE_CLASS2(UNavPathObserverInterface, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UNavPathObserverInterface_NoRegister) \
