...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_ALocalFogVolume_NoRegister(); \
public: \
	DECLARE_CLASS2(ALocalFogVolume, AInfo, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_ALocalFogVolume_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Engine_LocalFogVolume_h_18_STANDARD_CONSTRUCTORS \
	...
	ALocalFogVolume(ALocalFogVolume&&) = delete; \
	ALocalFogVolume(const ALocalFogVolume&) = delete; \
