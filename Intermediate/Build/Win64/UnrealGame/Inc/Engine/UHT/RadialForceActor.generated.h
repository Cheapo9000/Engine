...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_ARadialForceActor_NoRegister(); \
public: \
	DECLARE_CLASS2(ARadialForceActor, ARigidBodyBase, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_ARadialForceActor_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_RadialForceActor_h_16_STANDARD_CONSTRUCTORS \
	...
	ARadialForceActor(ARadialForceActor&&) = delete; \
	ARadialForceActor(const ARadialForceActor&) = delete; \
