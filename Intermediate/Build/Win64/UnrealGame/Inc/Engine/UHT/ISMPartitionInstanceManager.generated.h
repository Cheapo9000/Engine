...
#define FID_Engine_Source_Runtime_Engine_Public_ISMPartition_ISMPartitionInstanceManager_h_21_ENHANCED_CONSTRUCTORS \
	...
	UISMPartitionInstanceManager(UISMPartitionInstanceManager&&) = delete; \
	UISMPartitionInstanceManager(const UISMPartitionInstanceManager&) = delete; \
	...
	virtual ~UISMPartitionInstanceManager() = default;
...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UISMPartitionInstanceManager_NoRegister(); \
public: \
	DECLARE_CLASS2(UISMPartitionInstanceManager, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UISMPartitionInstanceManager_NoRegister) \
...
class UISMPartitionInstanceManager;
...
#define FID_Engine_Source_Runtime_Engine_Public_ISMPartition_ISMPartitionInstanceManager_h_132_ENHANCED_CONSTRUCTORS \
	...
	/** Deleted move- and copy-constructors, should never be used */ \
	UISMPartitionInstanceManagerProvider(UISMPartitionInstanceManagerProvider&&) = delete; \
	UISMPartitionInstanceManagerProvider(const UISMPartitionInstanceManagerProvider&) = delete; \
	...
	virtual ~UISMPartitionInstanceManagerProvider() = default;
...
private: \
	...
	static UClass* GetPrivateStaticClass(); \
	friend ENGINE_API UClass* ::Z_Construct_UClass_UISMPartitionInstanceManagerProvider_NoRegister(); \
public: \
	DECLARE_CLASS2(UISMPartitionInstanceManagerProvider, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UISMPartitionInstanceManagerProvider_NoRegister) \
...
class UISMPartitionInstanceManagerProvider;
