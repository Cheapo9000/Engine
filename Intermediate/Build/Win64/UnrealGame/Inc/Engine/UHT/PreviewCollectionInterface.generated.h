...
#define FID_Engine_Source_Runtime_Engine_Public_Animation_PreviewCollectionInterface_h_17_STANDARD_CONSTRUCTORS \
	...
	UPreviewCollectionInterface(UPreviewCollectionInterface&&) = delete; \
	UPreviewCollectionInterface(const UPreviewCollectionInterface&) = delete; \
	virtual ~UPreviewCollectionInterface() = default;
...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UPreviewCollectionInterface_NoRegister(); \
public: \
	DECLARE_CLASS2(UPreviewCollectionInterface, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UPreviewCollectionInterface_NoRegister) \
