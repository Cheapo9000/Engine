...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_AEmitter_NoRegister(); \
public: \
	DECLARE_CLASS2(AEmitter, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_AEmitter_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Particles_Emitter_h_57_STANDARD_CONSTRUCTORS \
	...
	AEmitter(AEmitter&&) = delete; \
	AEmitter(const AEmitter&) = delete; \
