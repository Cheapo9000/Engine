...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UGameViewportClient_NoRegister(); \
public: \
	DECLARE_CLASS2(UGameViewportClient, UScriptViewportClient, COMPILED_IN_FLAGS(0 | CLASS_Transient | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UGameViewportClient_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Engine_GameViewportClient_h_72_STANDARD_CONSTRUCTORS \
	...
	UGameViewportClient(UGameViewportClient&&) = delete; \
	UGameViewportClient(const UGameViewportClient&) = delete;
