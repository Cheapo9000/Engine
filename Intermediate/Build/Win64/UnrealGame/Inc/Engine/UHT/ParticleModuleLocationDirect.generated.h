...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UParticleModuleLocationDirect_NoRegister(); \
public: \
	DECLARE_CLASS2(UParticleModuleLocationDirect, UParticleModuleLocationBase, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UParticleModuleLocationDirect_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Particles_Location_ParticleModuleLocationDirect_h_24_STANDARD_CONSTRUCTORS \
	...
	UParticleModuleLocationDirect(UParticleModuleLocationDirect&&) = delete; \
	UParticleModuleLocationDirect(const UParticleModuleLocationDirect&) = delete; \
