...
#define FID_Engine_Source_Runtime_Engine_Public_DeformableInterface_h_16_STANDARD_CONSTRUCTORS \
	...
	UDeformableInterface(UDeformableInterface&&) = delete; \
	UDeformableInterface(const UDeformableInterface&) = delete; \
	virtual ~UDeformableInterface() = default;
...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UDeformableInterface_NoRegister(); \
public: \
	DECLARE_CLASS2(UDeformableInterface, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UDeformableInterface_NoRegister) \
