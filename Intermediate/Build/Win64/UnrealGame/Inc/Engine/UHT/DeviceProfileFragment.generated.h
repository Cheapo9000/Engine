...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UDeviceProfileFragment_NoRegister(); \
public: \
	DECLARE_CLASS2(UDeviceProfileFragment, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UDeviceProfileFragment_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_DeviceProfiles_DeviceProfileFragment_h_16_STANDARD_CONSTRUCTORS \
	...
	UDeviceProfileFragment(UDeviceProfileFragment&&) = delete; \
	UDeviceProfileFragment(const UDeviceProfileFragment&) = delete; \
