...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UGameUserSettings_NoRegister(); \
public: \
	DECLARE_CLASS2(UGameUserSettings, UObject, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UGameUserSettings_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_GameFramework_GameUserSettings_h_40_STANDARD_CONSTRUCTORS \
	...
	UGameUserSettings(UGameUserSettings&&) = delete; \
	UGameUserSettings(const UGameUserSettings&) = delete; \
...
template<> ENGINE_NON_ATTRIBUTED_API UEnum* StaticEnum<EWindowMode::Type>();
