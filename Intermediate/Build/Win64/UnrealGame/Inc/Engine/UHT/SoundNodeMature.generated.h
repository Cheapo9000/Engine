...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_USoundNodeMature_NoRegister(); \
public: \
	DECLARE_CLASS2(USoundNodeMature, USoundNode, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_USoundNodeMature_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeMature_h_23_STANDARD_CONSTRUCTORS \
	...
	USoundNodeMature(USoundNodeMature&&) = delete; \
	USoundNodeMature(const USoundNodeMature&) = delete; \
