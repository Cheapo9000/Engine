...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_APhysicsThruster_NoRegister(); \
public: \
	DECLARE_CLASS2(APhysicsThruster, ARigidBodyBase, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_APhysicsThruster_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_PhysicsThruster_h_19_STANDARD_CONSTRUCTORS \
	...
	APhysicsThruster(APhysicsThruster&&) = delete; \
	APhysicsThruster(const APhysicsThruster&) = delete; \
