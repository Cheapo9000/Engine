...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_AGameNetworkManager_NoRegister(); \
public: \
	DECLARE_CLASS2(AGameNetworkManager, AInfo, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_AGameNetworkManager_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_GameFramework_GameNetworkManager_h_29_STANDARD_CONSTRUCTORS \
	...
	AGameNetworkManager(AGameNetworkManager&&) = delete; \
	AGameNetworkManager(const AGameNetworkManager&) = delete; \
...
template<> ENGINE_NON_ATTRIBUTED_API UEnum* StaticEnum<EStandbyType>();
