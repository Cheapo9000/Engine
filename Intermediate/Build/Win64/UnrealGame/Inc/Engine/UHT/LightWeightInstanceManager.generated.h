...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_ALightWeightInstanceManager_NoRegister(); \
public: \
	DECLARE_CLASS2(ALightWeightInstanceManager, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_ALightWeightInstanceManager_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_GameFramework_LightWeightInstanceManager_h_33_STANDARD_CONSTRUCTORS \
	...
	ALightWeightInstanceManager(ALightWeightInstanceManager&&) = delete; \
	ALightWeightInstanceManager(const ALightWeightInstanceManager&) = delete;
