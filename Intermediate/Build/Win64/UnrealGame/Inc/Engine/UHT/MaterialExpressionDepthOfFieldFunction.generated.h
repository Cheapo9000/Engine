...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UMaterialExpressionDepthOfFieldFunction_NoRegister(); \
public: \
	DECLARE_CLASS2(UMaterialExpressionDepthOfFieldFunction, UMaterialExpression, COMPILED_IN_FLAGS(0 | CLASS_Optional | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UMaterialExpressionDepthOfFieldFunction_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Public_Materials_MaterialExpressionDepthOfFieldFunction_h_30_STANDARD_CONSTRUCTORS \
	...
	UMaterialExpressionDepthOfFieldFunction(UMaterialExpressionDepthOfFieldFunction&&) = delete; \
	UMaterialExpressionDepthOfFieldFunction(const UMaterialExpressionDepthOfFieldFunction&) = delete; \
...
template<> ENGINE_NON_ATTRIBUTED_API UEnum* StaticEnum<EDepthOfFieldFunctionValue>();
