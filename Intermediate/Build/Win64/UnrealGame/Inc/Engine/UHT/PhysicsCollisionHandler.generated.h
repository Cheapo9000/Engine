...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UPhysicsCollisionHandler_NoRegister(); \
public: \
	DECLARE_CLASS2(UPhysicsCollisionHandler, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UPhysicsCollisionHandler_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_PhysicsCollisionHandler_h_17_STANDARD_CONSTRUCTORS \
	...
	UPhysicsCollisionHandler(UPhysicsCollisionHandler&&) = delete; \
	UPhysicsCollisionHandler(const UPhysicsCollisionHandler&) = delete; \
