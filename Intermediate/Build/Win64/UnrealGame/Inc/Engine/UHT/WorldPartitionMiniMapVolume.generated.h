...
// ********** Begin Class AWorldPartitionMiniMapVolume *********************************************
...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_AWorldPartitionMiniMapVolume_NoRegister(); \
public: \
	DECLARE_CLASS2(AWorldPartitionMiniMapVolume, AVolume, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_AWorldPartitionMiniMapVolume_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionMiniMapVolume_h_11_ENHANCED_CONSTRUCTORS \
	...
	AWorldPartitionMiniMapVolume(AWorldPartitionMiniMapVolume&&) = delete; \
	AWorldPartitionMiniMapVolume(const AWorldPartitionMiniMapVolume&) = delete; \
...
class AWorldPartitionMiniMapVolume;

// ********** End Class AWorldPartitionMiniMapVolume ***********************************************
