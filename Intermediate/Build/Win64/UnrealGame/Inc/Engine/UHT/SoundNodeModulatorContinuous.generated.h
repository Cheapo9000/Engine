...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_USoundNodeModulatorContinuous_NoRegister(); \
public: \
	DECLARE_CLASS2(USoundNodeModulatorContinuous, USoundNode, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_USoundNodeModulatorContinuous_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeModulatorContinuous_h_77_STANDARD_CONSTRUCTORS \
	...
	USoundNodeModulatorContinuous(USoundNodeModulatorContinuous&&) = delete; \
	USoundNodeModulatorContinuous(const USoundNodeModulatorContinuous&) = delete; \
...
template<> ENGINE_NON_ATTRIBUTED_API UEnum* StaticEnum<ModulationParamMode>();
