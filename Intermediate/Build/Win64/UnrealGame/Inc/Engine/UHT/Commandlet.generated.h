...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UCommandlet_NoRegister(); \
public: \
	DECLARE_CLASS2(UCommandlet, UObject, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Transient), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UCommandlet_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Commandlets_Commandlet_h_42_STANDARD_CONSTRUCTORS \
	...
	UCommandlet(UCommandlet&&) = delete; \
	UCommandlet(const UCommandlet&) = delete; \
