...
#define FID_Engine_Source_Runtime_Engine_Classes_Interfaces_Interface_ActorSubobject_h_18_STANDARD_CONSTRUCTORS \
	...
	UInterface_ActorSubobject(UInterface_ActorSubobject&&) = delete; \
	UInterface_ActorSubobject(const UInterface_ActorSubobject&) = delete; \
	virtual ~UInterface_ActorSubobject() = default;
...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UInterface_ActorSubobject_NoRegister(); \
public: \
	DECLARE_CLASS2(UInterface_ActorSubobject, UInterface, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Interface), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UInterface_ActorSubobject_NoRegister) \
