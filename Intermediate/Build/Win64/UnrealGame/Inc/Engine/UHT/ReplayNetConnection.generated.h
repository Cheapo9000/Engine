...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UReplayNetConnection_NoRegister(); \
public: \
	DECLARE_CLASS2(UReplayNetConnection, UNetConnection, COMPILED_IN_FLAGS(0 | CLASS_Transient | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UReplayNetConnection_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Public_ReplayNetConnection_h_14_ENHANCED_CONSTRUCTORS \
	...
	UReplayNetConnection(UReplayNetConnection&&) = delete; \
	UReplayNetConnection(const UReplayNetConnection&) = delete; \
