...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_ALevelStreamingVolume_NoRegister(); \
public: \
	DECLARE_CLASS2(ALevelStreamingVolume, AVolume, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_ALevelStreamingVolume_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Engine_LevelStreamingVolume_h_31_STANDARD_CONSTRUCTORS \
	...
	ALevelStreamingVolume(ALevelStreamingVolume&&) = delete; \
	ALevelStreamingVolume(const ALevelStreamingVolume&) = delete; \
...
template<> ENGINE_NON_ATTRIBUTED_API UEnum* StaticEnum<EStreamingVolumeUsage>();
