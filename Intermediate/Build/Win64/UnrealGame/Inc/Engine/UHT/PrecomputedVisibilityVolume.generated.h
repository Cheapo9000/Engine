...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_APrecomputedVisibilityVolume_NoRegister(); \
public: \
	DECLARE_CLASS2(APrecomputedVisibilityVolume, AVolume, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_APrecomputedVisibilityVolume_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Lightmass_PrecomputedVisibilityVolume_h_17_STANDARD_CONSTRUCTORS \
	...
	APrecomputedVisibilityVolume(APrecomputedVisibilityVolume&&) = delete; \
	APrecomputedVisibilityVolume(const APrecomputedVisibilityVolume&) = delete; \
