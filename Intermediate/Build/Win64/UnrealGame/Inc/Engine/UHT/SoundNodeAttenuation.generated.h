...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_USoundNodeAttenuation_NoRegister(); \
public: \
	DECLARE_CLASS2(USoundNodeAttenuation, USoundNode, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_USoundNodeAttenuation_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeAttenuation_h_22_STANDARD_CONSTRUCTORS \
	...
	USoundNodeAttenuation(USoundNodeAttenuation&&) = delete; \
	USoundNodeAttenuation(const USoundNodeAttenuation&) = delete; \
