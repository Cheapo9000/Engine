...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UParticleModuleSourceMovement_NoRegister(); \
public: \
	DECLARE_CLASS2(UParticleModuleSourceMovement, UParticleModuleLocationBase, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UParticleModuleSourceMovement_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Particles_Location_ParticleModuleSourceMovement_h_17_STANDARD_CONSTRUCTORS \
	...
	UParticleModuleSourceMovement(UParticleModuleSourceMovement&&) = delete; \
	UParticleModuleSourceMovement(const UParticleModuleSourceMovement&) = delete; \
