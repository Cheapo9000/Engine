...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_USoundNodeWavePlayer_NoRegister(); \
public: \
	DECLARE_CLASS2(USoundNodeWavePlayer, USoundNodeAssetReferencer, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_USoundNodeWavePlayer_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeWavePlayer_h_25_ENHANCED_CONSTRUCTORS \
	...
	USoundNodeWavePlayer(USoundNodeWavePlayer&&) = delete; \
	USoundNodeWavePlayer(const USoundNodeWavePlayer&) = delete; \
