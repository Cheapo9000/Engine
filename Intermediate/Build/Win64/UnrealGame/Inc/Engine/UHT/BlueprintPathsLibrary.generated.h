...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UBlueprintPathsLibrary_NoRegister(); \
public: \
	DECLARE_CLASS2(UBlueprintPathsLibrary, UBlueprintFunctionLibrary, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UBlueprintPathsLibrary_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Kismet_BlueprintPathsLibrary_h_19_STANDARD_CONSTRUCTORS \
	...
	ENGINE_API UBlueprintPathsLibrary(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
	DEFINE_DEFAULT_OBJECT_INITIALIZER_CONSTRUCTOR_CALL(UBlueprintPathsLibrary) \
	DECLARE_VTABLE_PTR_HELPER_CTOR(ENGINE_API, UBlueprintPathsLibrary); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UBlueprintPathsLibrary); \
	/** Deleted move- and copy-constructors, should never be used */ \
	UBlueprintPathsLibrary(UBlueprintPathsLibrary&&) = delete; \
	UBlueprintPathsLibrary(const UBlueprintPathsLibrary&) = delete; \
	ENGINE_API virtual ~UBlueprintPathsLibrary();
