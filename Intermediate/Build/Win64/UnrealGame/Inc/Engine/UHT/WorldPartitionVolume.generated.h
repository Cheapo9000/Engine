...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_ADEPRECATED_WorldPartitionVolume_NoRegister(); \
public: \
	DECLARE_CLASS2(ADEPRECATED_WorldPartitionVolume, AVolume, COMPILED_IN_FLAGS(0 | CLASS_Config | CLASS_Deprecated), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_ADEPRECATED_WorldPartitionVolume_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionVolume_h_14_STANDARD_CONSTRUCTORS \
	...
	ADEPRECATED_WorldPartitionVolume(ADEPRECATED_WorldPartitionVolume&&) = delete; \
	ADEPRECATED_WorldPartitionVolume(const ADEPRECATED_WorldPartitionVolume&) = delete; \
