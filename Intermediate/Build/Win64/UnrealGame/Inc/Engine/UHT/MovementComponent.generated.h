...
#define FID_Engine_Source_Runtime_Engine_Classes_GameFramework_MovementComponent_h_72_ARCHIVESERIALIZER \
	DECLARE_FSTRUCTUREDARCHIVE_SERIALIZER(UMovementComponent, ENGINE_API)
...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UMovementComponent_NoRegister(); \
public: \
	DECLARE_CLASS2(UMovementComponent, UActorComponent, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Config), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UMovementComponent_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_GameFramework_MovementComponent_h_72_STANDARD_CONSTRUCTORS \
	...
	ENGINE_API UMovementComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
	DEFINE_ABSTRACT_DEFAULT_OBJECT_INITIALIZER_CONSTRUCTOR_CALL(UMovementComponent) \
	DECLARE_VTABLE_PTR_HELPER_CTOR(ENGINE_API, UMovementComponent); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UMovementComponent); \
	/** Deleted move- and copy-constructors, should never be used */ \
	UMovementComponent(UMovementComponent&&) = delete; \
	UMovementComponent(const UMovementComponent&) = delete; \
	ENGINE_API virtual ~UMovementComponent();
