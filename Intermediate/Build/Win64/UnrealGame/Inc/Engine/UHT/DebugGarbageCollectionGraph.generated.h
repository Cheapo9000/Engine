...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UDebugGarbageCollectionGraph_NoRegister(); \
public: \
	DECLARE_CLASS2(UDebugGarbageCollectionGraph, UObject, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UDebugGarbageCollectionGraph_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Private_DebugGarbageCollectionGraph_h_14_ENHANCED_CONSTRUCTORS \
	...
	UDebugGarbageCollectionGraph(UDebugGarbageCollectionGraph&&) = delete; \
	UDebugGarbageCollectionGraph(const UDebugGarbageCollectionGraph&) = delete; \
...
class UDebugGarbageCollectionGraph;
