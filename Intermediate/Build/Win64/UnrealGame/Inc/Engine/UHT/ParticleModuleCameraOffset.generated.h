...
private: \
	...
	friend ENGINE_API UClass* ::Z_Construct_UClass_UParticleModuleCameraOffset_NoRegister(); \
public: \
	DECLARE_CLASS2(UParticleModuleCameraOffset, UParticleModuleCameraBase, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/Engine"), Z_Construct_UClass_UParticleModuleCameraOffset_NoRegister) \
...
#define FID_Engine_Source_Runtime_Engine_Classes_Particles_Camera_ParticleModuleCameraOffset_h_30_STANDARD_CONSTRUCTORS \
	...
	UParticleModuleCameraOffset(UParticleModuleCameraOffset&&) = delete; \
	UParticleModuleCameraOffset(const UParticleModuleCameraOffset&) = delete; \
...
template<> ENGINE_NON_ATTRIBUTED_API UEnum* StaticEnum<EParticleCameraOffsetUpdateMethod>();
